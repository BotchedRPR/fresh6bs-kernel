...
#include "../../soc/samsung/cal-if/s5e5515/cmucal/cmucal-vclk.h"
#include "../../soc/samsung/cal-if/s5e5515/cmucal/cmucal-node.h"
#include "../../soc/samsung/cal-if/s5e5515/cmucal/cmucal-qch.h"
#include "../../soc/samsung/cal-if/s5e5515/cmucal/clkout_s5e5515.h"
...
struct samsung_fixed_rate s5e5515_fixed_rate_ext_clks[] = {
	FRATE(OSCCLK, "fin_pll", NULL, 0, 26000000),
};

/* HWACG VCLK */

struct init_vclk s5e5515_cmgp_hwacg_vclks[] = {
...
struct init_vclk s5e5515_core_hwacg_vclks[] = {
...
struct init_vclk s5e5515_dpu_hwacg_vclks[] = {
...
struct init_vclk s5e5515_fsys_hwacg_vclks[] = {
...
struct init_vclk s5e5515_mfc_hwacg_vclks[] = {
...
struct init_vclk s5e5515_peri_hwacg_vclks[] = {
...
struct init_vclk s5e5515_vts_hwacg_vclks[] = {
...
/* Special VCLK */
struct init_vclk s5e5515_apm_vclks[] = {
	VCLK(APM_BUS, DIV_CLK_APM_BUS, "APM_BUS", 0, 0, NULL),
};

struct init_vclk s5e5515_top_vclks[] = {
...
struct init_vclk s5e5515_cmgp_vclks[] = {
...
struct init_vclk s5e5515_dpu_vclks[] = {
...
struct init_vclk s5e5515_fsys_vclks[] = {
...
struct init_vclk s5e5515_peri_vclks[] = {
...
struct init_vclk s5e5515_vts_vclks[] = {
...
/* Clock out */
struct init_vclk s5e5515_clkout_vclks[] = {
...
static int s5e5515_clock_probe(struct platform_device *pdev)
{
...
static struct platform_driver s5e5515_clock_driver = {
    .driver = {
        .name = "s5e5515_clock",
        .of_match_table = of_exynos_clock_match,
    },
    .probe      = s5e5515_clock_probe,
    .id_table   = exynos_clock_ids,
};

static int s5e5515_clock_init(void)
{
    return platform_driver_register(&s5e5515_clock_driver);
}
arch_initcall(s5e5515_clock_init);

static void s5e5515_clock_exit(void)
{
    return platform_driver_unregister(&s5e5515_clock_driver);
}
module_exit(s5e5515_clock_exit);
