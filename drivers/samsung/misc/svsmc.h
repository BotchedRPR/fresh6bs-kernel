...
#define SVSMC_MAGIC 'S'

#define CMD_SHA_INIT	_IOW(SVSMC_MAGIC, SHA_INIT, smc_ioctl_info)
#define CMD_SHA_UPDATE	_IOW(SVSMC_MAGIC, SHA_UPDATE, smc_ioctl_info)
#define CMD_SHA_FINAL	_IOW(SVSMC_MAGIC, SHA_FINAL, smc_ioctl_info)
#define CMD_SHA_DIGEST	_IOW(SVSMC_MAGIC, SHA_DIGEST, smc_ioctl_info)
