...
#define SENSOR_INFO_DIGITAL_HALL_EVENT_15                       {"digital_hall_event_15", false, REPORT_MODE_UNKNOWN, 4, 4}
#if defined(CONFIG_SENSORS_SSP_LUCKY)
#define SENSOR_INFO_LIGHT                                       {"light_sensor", true, REPORT_MODE_ON_CHANGE, 2, 4}
#else
#define SENSOR_INFO_LIGHT                                       {"light_sensor", true, REPORT_MODE_ON_CHANGE, 28, 4}
#endif
...
#define SENSOR_INFO_AOD                                    		{"aod_auto_brightness_sensor", true, REPORT_MODE_ON_CHANGE, 8, 8}
...
#define SENSOR_INFO_LIGHT_CCT                                   {"light_cct_sensor", true, REPORT_MODE_CONTINUOUS, 28, 4}
