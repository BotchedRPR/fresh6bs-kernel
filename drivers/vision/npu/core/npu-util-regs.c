...
static struct npu_reg_format npu_dsp_sfr_reg[] = {
	{ 0x20000, 0, 0, 0, 0, 0x127c, "DNC_CTRL_NS" },
	{ 0xA0000, 0, 0, 0, 0, 0x50, "SDMA_SHADOW_NS"},
	...
	{ 0x202000, 0, 0, 0, 0, 0x318, "NPUCORE0_CMDQ_CORE0" },
	{ 0x204000, 0, 0, 0, 0, 0x318, "NPUCORE0_CMDQ_CORE1" },
	{ 0x210000, 0, 0, 0, 0, 0x130, "NPUCORE0_NPUC_CTRL" },
	{ 0x302000, 0, 0, 0, 0, 0x318, "NPUCORE1_CMDQ_CORE0" },
	{ 0x304000, 0, 0, 0, 0, 0x318, "NPUCORE1_CMDQ_CORE1" },
	{ 0x310000, 0, 0, 0, 0, 0x130, "NPUCORE1_NPUC_CTRL" },
};

static struct npu_reg_format dsp0_ctrl_sfr_reg[] = {
	/* REG_DSP0_CTRL */
	{ 0x180000, 0x0000, 0, 0, 0, 1, "DSP_CTRL_BUSACTREQ" },
	{ 0x180000, 0x0004, 0, 0, 0, 1, "DSP_CTRL_SWRESET" },
	{ 0x180000, 0x0008, 0, 0, 0, 1, "DSP_CTRL_CORE_ID" },
	{ 0x180000, 0x0010, 0, 0, 0, 1, "DSP_CTRL_PERF_MON_ENABLE" },
	{ 0x180000, 0x0014, 0, 0, 0, 1, "DSP_CTRL_PERF_MON_CLEAR" },
	{ 0x180000, 0x0018, 0, 0, 0, 1, "DSP_CTRL_DBG_MON_ENABLE" },
	{ 0x180000, 0x0020, 0, 0, 0, 1, "DSP_CTRL_DBG_INTR_STATUS" },
	{ 0x180000, 0x0024, 0, 0, 0, 1, "DSP_CTRL_DBG_INTR_ENABLE" },
	{ 0x180000, 0x0028, 0, 0, 0, 1, "DSP_CTRL_DBG_INTR_CLEAR" },
	{ 0x180000, 0x002C, 0, 0, 0, 1, "DSP_CTRL_DBG_INTR_MSTATUS" },
	{ 0x180000, 0x0030, 0, 0, 0, 1, "DSP_CTRL_IVP_SFR2AXI_SGMO" },
	// { 0x180000, 0x0038, 0, 0, 0, 1, "DSP_CTRL_SRESET_DONE_STATUS" },
	{ 0x180000, 0x0040, 0, 0, 8, 1, "DSP_CTRL_VM_STATCK_START$" },
	{ 0x180000, 0x0044, 0, 0, 8, 1, "DSP_CTRL_VM_STATCK_END$" },
	{ 0x180000, 0x0060, 0, 0, 0, 1, "DSP_CTRL_VM_MODE" },
	{ 0x180000, 0x0080, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_TH0_PC" },
	{ 0x180000, 0x0084, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_TH0_VALID_CNTL" },
	{ 0x180000, 0x0088, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_TH0_VALID_CNTH" },
	{ 0x180000, 0x008C, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_TH0_STALL_CNT" },
	{ 0x180000, 0x0090, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_TH1_PC" },
	{ 0x180000, 0x0094, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_TH1_VALID_CNTL" },
	{ 0x180000, 0x0098, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_TH1_VALID_CNTH" },
	{ 0x180000, 0x009C, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_TH1_STALL_CNT" },
	{ 0x180000, 0x00A0, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_IC_REQL" },
	{ 0x180000, 0x00A4, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_IC_REQH" },
	{ 0x180000, 0x00A8, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_IC_MISS" },
	{ 0x180000, 0x00AC, 0, 0, 8, 1, "DSP_CTRL_PERF_IVP_INST_CNTL$" },
	{ 0x180000, 0x00B0, 0, 0, 8, 1, "DSP_CTRL_PERF_IVP_INST_CNTH$" },
	// { 0x180000, 0x00CC, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_TH0_PC" },
	// { 0x180000, 0x00D0, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_TH0_VALID_CNTL" },
	// { 0x180000, 0x00D4, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_TH0_VALID_CNTH" },
	// { 0x180000, 0x00D8, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_TH0_STALL_CNT" },
	// { 0x180000, 0x00DC, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_TH1_PC" },
	// { 0x180000, 0x00E0, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_TH1_VALID_CNTL" },
	// { 0x180000, 0x00E4, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_TH1_VALID_CNTH" },
	// { 0x180000, 0x00E8, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_TH1_STALL_CNT" },
	// { 0x180000, 0x00EC, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_IC_REQL" },
	// { 0x180000, 0x00F0, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_IC_REQH" },
	// { 0x180000, 0x00F4, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_IC_MISS" },
	// { 0x180000, 0x00F8, 0, 0, 8, 1, "DSP_CTRL_PERF_IVP_INST_CNTL$" },
	// { 0x180000, 0x00FC, 0, 0, 8, 1, "DSP_CTRL_PERF_IVP_INST_CNTH$" },
	{ 0x180000, 0x0128, 0, 0, 0, 1, "DSP_CTRL_DBG_IVP_ADDR_PM" },
	{ 0x180000, 0x012c, 0, 0, 0, 1, "DSP_CTRL_DBG_IVP_ADDR_DM" },
	{ 0x180000, 0x0130, 0, 0, 0, 1, "DSP_CTRL_DBG_IVP_ERROR_INFO" },
	// { 0x180000, 0x0154, 0, 0, 0, 1, "DSP_CTRL_DBG_IVP_ADDR_PM" },
	// { 0x180000, 0x0158, 0, 0, 0, 1, "DSP_CTRL_DBG_IVP_ADDR_DM" },
	// { 0x180000, 0x015c, 0, 0, 0, 1, "DSP_CTRL_DBG_IVP_ERROR_INFO" },
	{ 0x180000, 0x0180, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_STALL_CNTL" },
	{ 0x180000, 0x0184, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_STALL_CNTH" },
	{ 0x180000, 0x0188, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_SFR_STALL_CNTL" },
	{ 0x180000, 0x018c, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_SFR_STALL_CNTH" },
	{ 0x180000, 0x0190, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_VM0_STALL_CNTL" },
	{ 0x180000, 0x0194, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_VM0_STALL_CNTH" },
	{ 0x180000, 0x0198, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_VM1_STALL_CNTL" },
	{ 0x180000, 0x019c, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_VM1_STALL_CNTH" },
	{ 0x180000, 0x01a0, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_STALL_CNTL" },
	// { 0x180000, 0x01a4, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_STALL_CNTH" },
	// { 0x180000, 0x01a8, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_SFR_STALL_CNTL" },
	// { 0x180000, 0x01ac, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_SFR_STALL_CNTH" },
	// { 0x180000, 0x01b0, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_VM0_STALL_CNTL" },
	// { 0x180000, 0x01b4, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_VM0_STALL_CNTH" },
	// { 0x180000, 0x01b8, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_VM1_STALL_CNTL" },
	// { 0x180000, 0x01bc, 0, 0, 0, 1, "DSP_CTRL_PERF_IVP_VM1_STALL_CNTH" },
	// { 0x180000, 0x01c8, 0, 0, 4, 1, "DSP_CTRL_SM_ID$" },
	{ 0x180000, 0x01d8, 0, 0, 4, 1, "DSP_CTRL_SM_ADDR$" },
	{ 0x180000, 0x01e8, 0, 0, 0, 1, "DSP_CTRL_IVP_STM_FUNC_STATUS0" },
	{ 0x180000, 0x01ec, 0, 0, 0, 1, "DSP_CTRL_IVP_STM_FUNC_STATUS1" },
	{ 0x180000, 0x0208, 0, 0, 0, 1, "DSP_CTRL_AXI_ERROR_RD" },
	{ 0x180000, 0x020c, 0, 0, 0, 1, "DSP_CTRL_AXI_ERROR_WR" },
	{ 0x180000, 0x0210, 0, 0, 4, 1, "DSP_CTRL_RD_MOCNT$" },
	{ 0x180000, 0x0280, 0, 0, 4, 1, "DSP_CTRL_WR_MOCNT$" },
	{ 0x180000, 0x0400, 0, 0, 0, 1, "DSP_CTRL_IVP_WAKEUP" },
	{ 0x180000, 0x0404, 0, 0, 4, 1, "DSP_CTRL_IVP_INTR_STATUS_TH$" },
	{ 0x180000, 0x040c, 0, 0, 4, 1, "DSP_CTRL_IVP_INTR_ENABLE_TH$" },
	{ 0x180000, 0x0414, 0, 0, 4, 1, "DSP_CTRL_IVP_SWI_SET_TH$" },
	{ 0x180000, 0x041c, 0, 0, 4, 1, "DSP_CTRL_IVP_SWI_CLEAR_TH$" },
	{ 0x180000, 0x0424, 0, 0, 4, 1, "DSP_CTRL_IVP_MASKED_STATUS_TH$" },
	{ 0x180000, 0x042c, 0, 0, 0, 1, "DSP_CTRL_IVP_IC_BASE_ADDR" },
	{ 0x180000, 0x0430, 0, 0, 0, 1, "DSP_CTRL_IVP_IC_CODE_SIZE" },
	{ 0x180000, 0x0434, 0, 0, 0, 1, "DSP_CTRL_IVP_IC_INVALID_REQ" },
	{ 0x180000, 0x0438, 0, 0, 0, 1, "DSP_CTRL_IVP_IC_INVALID_STATUS" },
	{ 0x180000, 0x043c, 0, 0, 8, 1, "DSP_CTRL_IVP_DM_STACK_START$" },
	{ 0x180000, 0x0440, 0, 0, 8, 1, "DSP_CTRL_IVP_DM_STACK_END$" },
	{ 0x180000, 0x044c, 0, 0, 0, 1, "DSP_CTRL_IVP_STATUS" },
	// { 0x180000, 0x0480, 0, 0, 0, 1, "DSP_CTRL_IVP_WAKEUP" },
	// { 0x180000, 0x0484, 0, 0, 4, 1, "DSP_CTRL_IVP_INTR_STATUS_TH$" },
	// { 0x180000, 0x048c, 0, 0, 4, 1, "DSP_CTRL_IVP_INTR_ENABLE_TH$" },
	// { 0x180000, 0x0494, 0, 0, 4, 1, "DSP_CTRL_IVP_SWI_SET_TH$" },
	// { 0x180000, 0x049c, 0, 0, 4, 1, "DSP_CTRL_IVP_SWI_CLEAR_TH$" },
	// { 0x180000, 0x04a4, 0, 0, 4, 1, "DSP_CTRL_IVP_MASKED_STATUS_TH$" },
	// { 0x180000, 0x04ac, 0, 0, 0, 1, "DSP_CTRL_IVP_IC_BASE_ADDR" },
	// { 0x180000, 0x04b0, 0, 0, 0, 1, "DSP_CTRL_IVP_IC_CODE_SIZE" },
	// { 0x180000, 0x04b4, 0, 0, 0, 1, "DSP_CTRL_IVP_IC_INVALID_REQ" },
	// { 0x180000, 0x04b8, 0, 0, 0, 1, "DSP_CTRL_IVP_IC_INVALID_STATUS" },
	// { 0x180000, 0x04bc, 0, 0, 8, 1, "DSP_CTRL_IVP_DM_STACK_START$" },
	// { 0x180000, 0x04c0, 0, 0, 8, 1, "DSP_CTRL_IVP_DM_STACK_END$" },
	// { 0x180000, 0x04cc, 0, 0, 0, 1, "DSP_CTRL_IVP_STATUS" },
	{ 0x180000, 0x0800, 0, 0, 0, 1, "DSP_CTRL_IVP_MAILBOX_INTR_TH0" },
	{ 0x180000, 0x0804, 0, 0, 4, 1, "DSP_CTRL_IVP_MAILBOX_TH0_$" },
	{ 0x180000, 0x0a00, 0, 0, 0, 1, "DSP_CTRL_IVP_MAILBOX_INTR_TH1" },
	{ 0x180000, 0x0a04, 0, 0, 4, 1, "DSP_CTRL_IVP_MAILBOX_TH1_$" },
	// { 0x180000, 0x0c00, 0, 0, 0, 1, "DSP_CTRL_IVP_MAILBOX_INTR_TH0" },
	// { 0x180000, 0x0c04, 0, 0, 4, 1, "DSP_CTRL_IVP_MAILBOX_TH0_$" },
	// { 0x180000, 0x0e00, 0, 0, 0, 1, "DSP_CTRL_IVP_MAILBOX_INTR_TH1" },
	// { 0x180000, 0x0e04, 0, 0, 4, 1, "DSP_CTRL_IVP_MAILBOX_TH1_$" },
	// { 0x180000, 0x1000, 0, 0, 4, 1, "DSP_CTRL_IVP_MSG_TH0_$" },
	// { 0x180000, 0x1400, 0, 0, 4, 1, "DSP_CTRL_IVP_MSG_TH1_$" },
	// { 0x180000, 0x1800, 0, 0, 4, 1, "DSP_CTRL_IVP_MSG_TH0_$" },
	// { 0x180000, 0x1c00, 0, 0, 4, 1, "DSP_CTRL_IVP_MSG_TH1_$" },
};
