...
#define VB_MAX_CONTAINERLIST		VISION_MAX_CONTAINERLIST
...
int vb_queue_init(struct vb_queue *q, void *alloc_ctx, const struct vb2_mem_ops *mem_ops,
	const struct vb_ops *ops, struct mutex *lock, u32 direction);
