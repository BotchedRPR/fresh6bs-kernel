...
#define SDMMC_DATA_TMOUT_EXT_ADD		0x1
#define SDMMC_DATA_TMOUT_EXT_SHIFT		8
#define SDMMC_DATA_TMOUT_EXT_MULTI		0xFFFFFF
#define SDMMC_DATA_TMOUT_EXT_MAX_CNT		0x7

#define SDMMC_DATA_EXT_TMOUT_SHIFT		12
#define SDMMC_DATA_EXT_TMOUT_CRT		16
#define SDMMC_DATA_EXT_TMOUT_MAX_CNT		0xFFFFF
#define SDMMC_DATA_EXT_TMOUT_EXT_ADD		0x1
#define SDMMC_DATA_EXT_TMOUT_EXT_SHIFT		8
#define SDMMC_DATA_EXT_TMOUT_EXT_MULTI		0x1000000
#define SDMMC_DATA_EXT_TMOUT_EXT_MAX_CNT	0xF
...
struct dw_mci_drv_data {
	...
	void (*req_err_check)(struct dw_mci *host, struct mmc_request *mrq);
