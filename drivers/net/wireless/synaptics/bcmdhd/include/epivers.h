...
#define EPI_COMMIT_ID		"(587f78a0)"

/* Driver Version String, ASCII, 32 chars max */
#if defined (WLTEST)
#define EPI_VERSION_STR		"101.10.361.12601.10 (WLTEST)"
#elif (defined (BCMDBG_ASSERT) && !defined (BCMDBG_ASSERT_DISABLED))
#define EPI_VERSION_STR		"101.10.361.12601.10 (ASSRT)"
#else
#define EPI_VERSION_STR		"101.10.361.12601.10"
#endif /* BCMINTERNAL */
