...
static struct gpio_dvs_t s5e5515_secgpio_dvs = {
	.result = &gpiomap_result,
	.check_gpio_status = check_gpio_status,
	.skip_grps = "gpb gpv", /* AUDIO, VTS */
};

const struct secgpio_dvs_data s5e5515_secgpio_dvs_data = {
	.gpio_dvs = &s5e5515_secgpio_dvs,
	.get_nr_gpio = samsung_pinctrl_get_nr_gpio,
};
EXPORT_SYMBOL_GPL(s5e5515_secgpio_dvs_data);
#endif /* CONFIG_PINCTRL_SEC_GPIO_DVS */
