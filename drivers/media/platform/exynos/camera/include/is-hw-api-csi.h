...
int csi_hw_top_dump(u32 __iomem *base_reg);
...
#else
int csi_hw_s_config_dma(u32 __iomem *base_reg, u32 channel,
		struct is_image *image, u32 hwformat, u32 dummy_pixel);
#endif
...
int csi_hw_s_config_dma_cmn(u32 __iomem *base_reg, u32 vc, u32 actual_vc,
