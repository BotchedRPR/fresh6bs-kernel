...
#define SIZE_OF_META_PLANE (sizeof(struct camera2_shot_ext))

#define CAMERA2_MAX_AVAILABLE_MODE		21
#define CAMERA2_MAX_FACES			16
#define CAMERA2_MAX_VENDER_LENGTH		400
#define CAMERA2_MAX_AF_VENDER_LENGTH		1200
...
#define CHK_UPDATE_EXP_BY_RTA_CAPTURE_SCN(captureIntent)  \
	...
	(captureIntent == AA_CAPTURE_INTENT_STILL_CAPTURE_STREAM_SHUTTER_CAR) || \
	(captureIntent == AA_CAPTURE_INTENT_STILL_CAPTURE_STREAM_SHUTTER_LIGHT) || \
	(captureIntent == AA_CAPTURE_INTENT_STILL_CAPTURE_STREAM_SHUTTER_PEDESTRIAN) || \
	(captureIntent == AA_CAPTURE_INTENT_STILL_CAPTURE_STREAM_SHUTTER_WATER) || \
	(captureIntent == AA_CAPTURE_INTENT_STILL_CAPTURE_STREAM_SHUTTER_STAR) || \
	(captureIntent == AA_CAPTURE_INTENT_STILL_CAPTURE_STREAM_SHUTTER_PORTRAIT) || \
	(captureIntent == AA_CAPTURE_INTENT_STILL_CAPTURE_RAW_HDR_SHOT) || \
	(captureIntent == AA_CAPTURE_INTENT_STILL_CAPTURE_RAW_LLHDR_SHOT) || \
	(captureIntent == AA_CAPTURE_INTENT_STILL_CAPTURE_FAST_NIGHT_SHOT) || \
	(captureIntent == AA_CAPTURE_INTENT_STILL_CAPTURE_SUPER_STAR_SHOT)) ? 1 : 0)
...
enum is_subscenario_id {
	ISS_SUB_SCENARIO_STILL_PREVIEW                          = 0,
	ISS_SUB_SCENARIO_VIDEO                                  = 1,
	ISS_SUB_SCENARIO_VIDEO_FHD                              = 2,
	ISS_SUB_SCENARIO_VIDEO_HD                               = 3,
	ISS_SUB_SCENARIO_VIDEO_SNAPSHOT                         = 4,
	ISS_SUB_SCENARIO_VIDEO_HIGH_SPEED                       = 5,
	ISS_SUB_SCENARIO_STILL_CAPTURE                          = 6,
	ISS_SUB_SCENARIO_UHD_30FPS                              = 7,
	ISS_SUB_SCENARIO_STILL_CAPTURE_WDR_ON                   = 8,
	ISS_SUB_SCENARIO_STILL_CAPTURE_LLS                      = 9,
	ISS_SUB_SCENARIO_FHD_240FPS                             = 10,
	ISS_SUB_SCENARIO_LIVE_OUTFOCUS_PREVIEW                  = 11,
	ISS_SUB_SCENARIO_LIVE_OUTFOCUS_CAPTURE                  = 12,
	ISS_SUB_SCENARIO_STILL_PREVIEW_3RD_PARTY_WDR_AUTO       = 13,
	ISS_SUB_SCENARIO_STILL_CAPTURE_SUPER_RESOLUTION         = 14,
	ISS_SUB_SCENARIO_STILL_CAPTURE_SUPER_NIGHT_SHOT         = 15,
	ISS_SUB_SCENARIO_STILL_CAPTURE_LLHDR                    = 16,
	ISS_SUB_SCENARIO_STILL_CAPTURE_FLASH_MFDN               = 17,
	ISS_SUB_SCENARIO_STILL_CAPTURE_REMOSAIC                 = 18,
	ISS_SUB_SCENARIO_STILL_CAPTURE_REMOSAIC_NIGHTSHOT       = 19,
	ISS_SUB_SCENARIO_STILL_CAPTURE_NIGHTSHOT                = 20,
	ISS_SUB_SCENARIO_STILL_CAPTURE_FUSION                   = 21,
	ISS_SUB_SCENARIO_STILL_CAPTURE_FUSION_NIGHTSHOT         = 22,
	ISS_SUB_SCENARIO_SMALLVIDEO_QQ                          = 23,
	ISS_SUB_SCENARIO_VIDEOCALL_QQ                           = 24,
	ISS_SUB_SCENARIO_SMALLVIDEO_WECHAT                      = 25,
	ISS_SUB_SCENARIO_VIDEOCALL_WECHAT_VGA                   = 26,
	ISS_SUB_SCENARIO_LIVE_OUTFOCUS_CAPTURE_NIGHT_SHOT       = 27,
	ISS_SUB_SCENARIO_LIVE_OUTFOCUS_CAPTURE_HDR              = 28,
	ISS_SUB_SCENARIO_LIVE_OUTFOCUS_CAPTURE_LLHDR            = 29,
	ISS_SUB_SCENARIO_STILL_CAPTURE_BEAUTY_FLASH             = 30,
	ISS_SUB_SCENARIO_LIVE_OUTFOCUS_CAPTURE_SUPER_NIGHT_SHOT = 31,
	ISS_SUB_SCENARIO_STILL_CAPTURE_HDROFF_NIGHTSHOT         = 32,
	ISS_SUB_SCENARIO_STILL_PREVIEW_BEAUTY                   = 33,
	ISS_SUB_SCENARIO_STILL_CAPTURE_BEAUTY                   = 34,
	ISS_SUB_SCENARIO_STILL_CAPTURE_BEAUTY_NIGHTSHOT         = 35,
	ISS_SUB_SCENARIO_STILL_CAPTURE_BEAUTY_HDR               = 36,
	ISS_SUB_SCENARIO_STILL_CAPTURE_BEAUTY_SUPER_NIGHTSHOT   = 37,
	ISS_SUB_SCENARIO_STILL_CAPTURE_BEAUTY_REMOSAIC          = 38,
	ISS_SUB_SCENARIO_STILL_PREVIEW_PANO                     = 39,
	ISS_SUB_SCENARIO_STILL_CAPTURE_PANO                     = 40,
	ISS_SUB_SCENARIO_VIDEOCALL_WECHAT_QVGA                  = 41,
	ISS_SUB_SCENARIO_STILL_CAPTURE_SPORT                    = 42,
	ISS_SUB_SCENARIO_LIVE_OUTFOCUS_CAPTURE_SPORTS           = 43,
	ISS_SUB_SCENARIO_STILL_CAPTURE_DNG_REPROCESSING         = 44,
	ISS_SUB_SCENARIO_STILL_CAPTURE_FACTORY_MODE             = 45,
	ISS_SUB_SCENARIO_STILL_PREVIEW_FACE_UNLOCK              = 46,
	ISS_SUB_SCENARIO_STILL_PREVIEW_FACTORY_MODE             = 47,
	ISS_SUB_SCENARIO_STILL_PREVIEW_FACTORY_OIS_CAPTURE      = 48,
	ISS_SUB_SCENARIO_STILL_CAPTURE_PRO_MODE                 = 49,
	ISS_SUB_SCENARIO_STILL_CAPTURE_THIRD_PARTY              = 50,
	ISS_SUB_SCENARIO_STILL_PREVIEW_SKIN_DETECTION           = 51,
	ISS_SUB_SCENARIO_STILL_CAPTURE_SKIN_DETECTION           = 52,
	ISS_SUB_SCENARIO_VIDEO_UHD_60FPS                        = 53,
	ISS_SUB_SCENARIO_REMOSAIC_PREVIEW                       = 54,
	ISS_SUB_SCENARIO_AR_PREVIEW                             = 55,
	ISS_SUB_SCENARIO_VIDEO_SNAPSHOT_4K                      = 56,
	ISS_SUB_SCENARIO_VIDEO_SUPEREIS                         = 57,
	ISS_SUB_SCENARIO_SUPER_MOON_CAPTURE                     = 58,
	ISS_SUB_SCENARIO_PRO_MODE_PREVIEW                       = 59,
	ISS_SUB_SCENARIO_TIKTOK                                 = 60,
	ISS_SUB_SCENARIO_SUPER_MOON_PREVIEW                     = 61,
	ISS_SUB_SCENARIO_VIDEO_NORMALEIS                        = 62,
	ISS_SUB_SCENARIO_VIDEO_WDR_ON                           = 63,
	ISS_SUB_SCENARIO_STILL_CAPTURE_LLHDR_AINR               = 65,
	ISS_SUB_SCENARIO_STILL_CAPTURE_RAWHDR_SPORT             = 66,
	ISS_SUB_SCENARIO_STILL_CAPTURE_RAWHDR_HDROFF            = 67,
	ISS_SUB_SCENARIO_STILL_CAPTURE_RAWHDR_HDROFF_AINR       = 68,
	ISS_SUB_SCENARIO_STILL_CAPTURE_FAST_NIGHT               = 69,
	ISS_SUB_SCENARIO_STILL_CAPTURE_PIXEL_SHIFT              = 70,
	ISS_SUB_SCENARIO_LIVE_OUTFOCUS_CAPTURE_RAW_LLHDR        = 72,
	ISS_SUB_SCENARIO_LIVE_OUTFOCUS_CAPTURE_RAW_LLHDR_AINR   = 73,
	ISS_SUB_SCENARIO_LIVE_OUTFOCUS_CAPTURE_RAW_HDROFF       = 74,
	ISS_SUB_SCENARIO_LIVE_OUTFOCUS_CAPTURE_RAW_HDROFF_AINR  = 75,
	ISS_SUB_SCENARIO_LIVE_OUTFOCUS_CAPTURE_RAWHDR_SPORT     = 76,
	ISS_SUB_SCENARIO_LIVE_OUTFOCUS_CAPTURE_FASTNIGHT        = 77,
	ISS_SUB_SCENARIO_STILL_CAPTURE_EXTREME_SUPERNS          = 79,
	ISS_SUB_SCENARIO_STILL_CAPTURE_TRIPOD_SUPERNS           = 80,
	ISS_SUB_SCENARIO_SHORT_VIDEO                            = 83,
	ISS_SUB_SCENARIO_DOCUMENT_DISTORTION                    = 85,
	ISS_SUB_SCENARIO_STILL_CAPTURE_SPORT_LEVEL0             = 86,
	ISS_SUB_SCENARIO_STILL_CAPTURE_SPORT_LEVEL1             = 87,
	ISS_SUB_SCENARIO_STILL_CAPTURE_SPORT_LEVEL2             = 88,
	ISS_SUB_SCENARIO_STILL_CAPTURE_SPORT_LEVEL3             = 89,
	ISS_SUB_SCENARIO_STILL_CAPTURE_SPORT_LEVEL4             = 90,
	ISS_SUB_SCENARIO_STILL_CAPTURE_SPORT_LEVEL5             = 91,
	ISS_SUB_SCENARIO_STALL_PREVIEW_STAR                     = 93,
	ISS_SUB_SCENARIO_STALL_CAPTURE_STAR                     = 94,
	ISS_SUB_SCENARIO_STALL_CAPTURE_STAR_HANDHELD            = 95,
	ISS_SUB_SCENARIO_STILL_CAPTURE_CAR                      = 96,
	ISS_SUB_SCENARIO_STILL_CAPTURE_LIGHT                    = 97,
	ISS_SUB_SCENARIO_STILL_CAPTURE_PEDESTRIAN               = 98,
	ISS_SUB_SCENARIO_STILL_CAPTURE_WATER                    = 99,
	ISS_SUB_SCENARIO_STILL_CAPTURE_STAR                     = 100,
	ISS_SUB_SCENARIO_STILL_CAPTURE_PORTRAIT                 = 101,
	ISS_SUB_END,
};
...
enum optical_stabilization_mode {
	...
	OPTICAL_STABILIZATION_MODE_FIXED,
	OPTICAL_STABILIZATION_MODE_CIR,
};
...
struct camera2_stats_dm {
	...
	uint32_t			faceLandmarks[CAMERA2_MAX_FACES][24];
...
enum aa_capture_intent {
	...
	AA_CAPTURE_INTENT_STILL_CAPTURE_SUPER_NIGHT_SHOT_HANDHELD_FAST,
	AA_CAPTURE_INTENT_STILL_CAPTURE_SUPER_NIGHT_SHOT_TRIPOD_FAST,
	AA_CAPTURE_INTENT_STILL_CAPTURE_SUPER_NIGHT_SHOT_TRIPOD_LE_FAST,
	...
	AA_CAPTURE_INTENT_STILL_CAPTURE_SHORT_REF_LLHDR_DYNAMIC_SHOT,
	AA_CAPTURE_INTENT_STILL_CAPTURE_PROCESSED_REMOSAIC_SINGLE,
	AA_CAPTURE_INTENT_STILL_CAPTURE_PROCESSED_REMOSAIC_DYNAMIC_SHOT,
	AA_CAPTURE_INTENT_STILL_CAPTURE_PROCESSED_REMOSAIC_MFHDR_DYNAMIC_SHOT,
	AA_CAPTURE_INTENT_STILL_CAPTURE_PROCESSED_REMOSAIC_SINGLE_FLASH,
	AA_CAPTURE_INTENT_STILL_CAPTURE_AIF_DYNAMIC_SHOT,
	AA_CAPTURE_INTENT_STILL_CAPTURE_GFHDR_DYNAMIC_SHOT,
	AA_CAPTURE_INTENT_STILL_CAPTURE_SUPER_NIGHT_SHOT_EXTREME_DARK,
	AA_CAPTURE_INTENT_STILL_CAPTURE_SUPER_NIGHT_SHOT_HANDHELD_MAX,
	AA_CAPTURE_INTENT_STILL_CAPTURE_SUPER_NIGHT_SHOT_TRIPOD_MAX,
	AA_CAPTURE_INTENT_STILL_CAPTURE_SUPER_NIGHT_SHOT_EXTREME_DARK_MAX,
	AA_CAPTURE_INTENT_STILL_CAPTURE_SR_HDR,

	AA_CAPTURE_INTENT_VIDEO_RECORD_CHANGE_FPS = 500,

	AA_CAPTURE_INTENT_STILL_CAPTURE_SPORT_MOTIONLEVEL = 10000,
	AA_CAPTURE_INTENT_STILL_CAPTURE_SUPER_MOON,
	AA_CAPTURE_INTENT_STILL_CAPTURE_REMOSAIC_EXPOSURE_DYNAMIC_SHOT,
	AA_CAPTURE_INTENT_STILL_CAPTURE_STREAM_SHUTTER_CAR,
	AA_CAPTURE_INTENT_STILL_CAPTURE_STREAM_SHUTTER_LIGHT,
	AA_CAPTURE_INTENT_STILL_CAPTURE_STREAM_SHUTTER_PEDESTRIAN,
	AA_CAPTURE_INTENT_STILL_CAPTURE_STREAM_SHUTTER_WATER,
	AA_CAPTURE_INTENT_STILL_CAPTURE_STREAM_SHUTTER_STAR,
	AA_CAPTURE_INTENT_STILL_CAPTURE_STREAM_SHUTTER_PORTRAIT,
	AA_CAPTURE_INTENT_STILL_CAPTURE_RAW_HDR_SHOT,
	AA_CAPTURE_INTENT_STILL_CAPTURE_RAW_LLHDR_SHOT,
	AA_CAPTURE_INTENT_STILL_CAPTURE_FAST_NIGHT_SHOT,
	AA_CAPTURE_INTENT_STILL_CAPTURE_SUPER_STAR_SHOT,
	AA_CAPTURE_INTENT_STILL_CAPTURE_RGB_PIXEL_SHIFT_SHOT,
	AA_CAPTURE_INTENT_STILL_CAPTURE_PANORAMA_SUPER_NIGHT_SHOT,
	AA_CAPTURE_INTENT_STILL_CAPTURE_PANORAMA_LLHDR_SHOT,
	AA_CAPTURE_INTENT_STILL_CAPTURE_PANORAMA_HDR_SHOT,
...
enum aa_scene_mode {
	...
	AA_SCENE_MODE_PORTRAIT_NIGHT,
	AA_SCENE_MODE_PORTRAIT_VERY_NIGHT,

	AA_SCENE_MODE_NOT_USED = 90000,
};
...
struct aa_ae_previewInfo
{
	float sensitivityShort;
	float sensitivitySafe;
	float sensitivityLong;
	float deltaEVShort;
	float deltaEVLong;
	float deltaEVSafe;
	float noFaceSensitivitySafe;
	float noFaceDeltaEvSafe;
};
...
struct camera2_aa_dm {
	...
	enum aa_aemode_state	vendor_aeModeState;
    ...
    float vendor_objectDistanceCmUnfiltered;
    uint32_t vendor_objectDistanceConfidence;
	int32_t				vendor_fpsHint;
	enum aa_dynamic_bds_mode	vendor_dynamicBdsInfo;
	int32_t				vendor_gfHdrEv[2];
	uint32_t			vendor_reserved[98];
	...
	uint32_t			vendor_reserved_dual[20];
};
...
struct camera2_gyro_sensor_history_info
{
    ...
    uint64_t gyroTimeStamp[20];		/* unit: us */
};
...
struct camera2_af_udm {
	uint32_t	vsLength;
	uint32_t	vendorSpecific[CAMERA2_MAX_AF_VENDER_LENGTH];
...
enum camera_op_mode {
	...
	CAMERA_OP_MODE_HAL3_FAC_LED = 10000,
	CAMERA_OP_MODE_HAL3_VC = 10001,
...
enum offline_data_type
{
	OFFLINE_DATA_NONE,
	OFFLINE_DATA_DRC,
	OFFLINE_DATA_FRM_DESC,
	OFFLINE_DATA_THUMBNAIL_STAT,
	OFFLINE_DATA_MAX = OFFLINE_DATA_THUMBNAIL_STAT,
};

struct offline_data_entry
{
	enum offline_data_type type;
	int size;
	int offset;
};

struct offline_data_desc
{
	uint64_t request;
	int cur_entry_size;
	uint32_t base_dvaddr;
	uint64_t base_kvaddr;
	struct offline_data_entry entry[OFFLINE_DATA_MAX];
};

struct offline_data {
	int fcount;
	int buf_fd;
	struct offline_data_desc data_desc;
};
...
struct camera2_meds_common_udm {
    ...
    uint16_t sensorBinning;
    uint16_t cropOffsetX;
    uint16_t cropOffsetY;
    uint16_t cropWidth;
    uint16_t cropHeight;
    uint16_t scalerWidth;
	uint16_t scalerHeight;
};
...
struct camera2_lmeds_udm {
	uint32_t yDsScaleFactor; // 4096 = x1.0
	uint16_t yDsOutputWidth;
	uint16_t yDsOutputHeight;
};
...
struct camera2_object_detect_uctl {
	...
	uint16_t object_roi[4]; /* RECT_IDX_LEFT, RECT_IDX_TOP, RECT_IDX_WIDTH, RECT_IDX_HEIGHT */
};
...
struct camera2_udm {
	...
	struct camera2_meds_common_udm meDsCommon;
	struct camera2_orbds_udm orbDs;
	struct camera2_lmeds_udm lmeDs;
	struct camera2_frame_info_udm frame_info;

	uint32_t reserved[20];
};

struct camera2_point {
	uint16_t x;
	uint16_t y;
};

struct camera2_object_roi {
	struct camera2_point leftUp;
	struct camera2_point rightUp;
	struct camera2_point rightDown;
	struct camera2_point leftDown;
};

enum aa_supermoonmode {
    AA_SUPER_MOON_MODE_OFF = 0,
    AA_SUPER_MOON_MODE_ON,
};

enum camera_panorama_hdr_start {
	CAMERA_PANORAMA_HDR_START_FALSE = 0,
	CAMERA_PANORAMA_HDR_START_TRUE = 1,
};

struct camera2_vctl {
	float					artificialLightSource[3];
	int32_t					flickerDetect;

	uint16_t				documentMode;
	enum aa_supermoonmode	superMoonMode;
	struct camera2_object_roi	objectArea;
	uint32_t				motionLevel;

	float					backwardGain[16];
	float					backwardShutter[16];
	uint32_t				vendorSceneMode;

	enum camera_panorama_hdr_start	panoHdrStartCapture;	/* for panorama capture */
	uint32_t				captureDrcGain;	/* for all the same rawHDR scenario capture */
	uint32_t				uiMode;	/* for rawhdr night mode and normal mode */
...
struct camera2_vdm
{
	struct aa_ae_previewInfo	aePreviewInfo;
	uint32_t					portraitFallback;
	uint32_t					aeSettle;
	uint32_t					antiBandingEnable;
	uint32_t					yuvhdrFrameSequence;
	uint32_t					bandingHdrNeeded;
...
struct camera2_shot {
	...
	struct camera2_vctl	vctl;
	struct camera2_vdm	vdm;
	/*magic : 23456789*/
	uint32_t		magicLowBarrier[10];
	uint32_t		magicNumber;
	uint32_t		magicHighBarrier[10];
};
...
struct is_dvfs_offline_dvfs_param {
	int32_t face;
	int32_t num;
	int32_t sensor;
	int32_t resol;
...
struct camera2_shot_ext_user {
	...
	struct sensor_mode_info         sensor_mode;
	struct is_dvfs_offline_dvfs_param	off_dvfs;
        uint32_t reserved[100];
};
...
struct camera2_stream {
	...
	uint32_t		halCameraId;
	uint32_t		halFcount;
	uint32_t		serviceFcount;
...
typedef struct camera2_vctl camera2_vctl_t;
typedef struct camera2_vdm camera2_vdm_t;
