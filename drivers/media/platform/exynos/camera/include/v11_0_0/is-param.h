...
struct lme_param_set {
	...
	pdma_addr_t			output_dva_sad[IS_MAX_PLANES];			/* H/W SAD dva */
	...
	pdma_addr_t			mbmv0_dva[IS_MAX_PLANES];	/* mbmvInFwBuffAddr */
	pdma_addr_t			mbmv1_dva[IS_MAX_PLANES];	/* mbmvOutFwBuffAddr */
	u32				instance_id;
	u32				fcount;
	bool				reprocessing;
	u32				tnr_mode;
...
struct cstat_param_set {
	...
	struct param_dma_output		cdaf_mw;

	pdma_addr_t			input_dva[IS_MAX_PLANES];
	pdma_addr_t			output_dva_lem_ds0[IS_MAX_PLANES];
	pdma_addr_t			output_dva_lem_ds1[IS_MAX_PLANES];
	pdma_addr_t			output_dva_fdpig[IS_MAX_PLANES];
	pdma_addr_t			output_dva_drc[IS_MAX_PLANES];
	pdma_addr_t			output_dva_cds[IS_MAX_PLANES];

	pdma_addr_t			pre_dva;
	pdma_addr_t			ae_dva;
	pdma_addr_t			awb_dva;
	pdma_addr_t			rbgy_dva;
	pdma_addr_t			cdaf_mw_dva;
...
struct byrp_param_set {
	...
	pdma_addr_t			input_dva[IS_MAX_PLANES];
	pdma_addr_t			input_dva_hdr[IS_MAX_PLANES];
	pdma_addr_t			output_dva_byr[IS_MAX_PLANES];
	pdma_addr_t			output_dva_byr_processed[IS_MAX_PLANES];
...
struct rgbp_param_set {
	...
	pdma_addr_t			output_dva_sf[IS_MAX_PLANES];
...
struct mcfp_param_set {
	...
	struct param_dma_input		dma_input_cur_w;
	...
	struct param_dma_input		dma_input_mv_mixer;
	struct param_dma_input		dma_input_sf;
	struct param_dma_output		dma_output_w;
	struct param_dma_output		dma_output_yuv;
	pdma_addr_t			input_dva[IS_MAX_PLANES];
	pdma_addr_t			input_dva_prv_yuv[IS_MAX_PLANES];
	pdma_addr_t			input_dva_prv_w[IS_MAX_PLANES];
	pdma_addr_t			input_dva_cur_w[IS_MAX_PLANES];
	pdma_addr_t			input_dva_drc_prv_map[IS_MAX_PLANES];
	pdma_addr_t			input_dva_drc_cur_map[IS_MAX_PLANES];
	pdma_addr_t			input_dva_mv[IS_MAX_PLANES];
	pdma_addr_t			input_dva_mv_mixer[IS_MAX_PLANES];
	pdma_addr_t			input_dva_sf[IS_MAX_PLANES];
	pdma_addr_t			output_dva_w[IS_MAX_PLANES];
	pdma_addr_t			output_dva_yuv[IS_MAX_PLANES];
