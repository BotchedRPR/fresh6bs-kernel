...
struct is_frame {
	...
	dma_addr_t orbxcTargetAddress[IS_MAX_PLANES];		/* MCH(ORBMCH) OUT DMA */
	u64 orbxcKTargetAddress[IS_MAX_PLANES];			/* MCH(ORBMCH) OUT KVA */
	u64 orbxmKTargetAddress[IS_MAX_PLANES];			/* MCH(ORBMCH) SW OUT KVA */
	dma_addr_t mchxsTargetAddress[IS_MAX_PLANES];		/* MCH(ORBMCH) PREV IN DMA */
	u64 mchxsKTargetAddress[IS_MAX_PLANES];			/* MCH(ORBMCH) PREV IN KVA */
