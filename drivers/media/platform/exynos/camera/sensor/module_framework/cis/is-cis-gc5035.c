...
int cis_gc5035_probe_i2c(struct i2c_client *client,
	const struct i2c_device_id *id)
{
	...
	char const *setfile;
#if defined(CONFIG_CAMERA_VENDER_MCD_V2) || defined(CONFIG_CAMERA_OTPROM_SUPPORT_FRONT) || defined(CONFIG_CAMERA_OTPROM_SUPPORT_REAR)
...
#else
#if defined(CONFIG_CAMERA_VENDER_MCD) && defined(CONFIG_CAMERA_OTPROM_SUPPORT_FRONT)
	rom_position = 0;
	specific = core->vender.private_data;
	specific->front_cis_client = client;
#endif
#if defined(CONFIG_CAMERA_VENDER_MCD) && defined(CONFIG_CAMERA_OTPROM_SUPPORT_REAR)
	rom_position = 0;
	specific = core->vender.private_data;
