					...
					bool skip, struct is_frame *frame, void *buf)
{
	...
	CALL_HW_OPS(hw_ip->hardware, dbg_trace, hw_ip, frame->fcount, DEBUG_POINT_RTA_REGS_E);
	...
	CALL_HW_OPS(hw_ip->hardware, dbg_trace, hw_ip, frame->fcount, DEBUG_POINT_RTA_REGS_X);
