...
static void byrp_hw_s_path(struct pablo_mmio *base, u32 set_id,
	bool mpc_en, bool hdr_en, bool dng_en)
{
	u32 val = 0;
	u32 input_0, input_1;
...
{
	bool cinfifo_en, coutfifo_en, bitmask_en, mono_mode_en, mpc_en, hdr_en, dtp_en, dng_en;
	u32 bit_in, bit_out;
	...
	byrp_hw_s_path(base, set_id, mpc_en, hdr_en, dng_en); /* TODO: MPC on/off is checked from cis */
