...
#ifndef IS_HW_API_MCSCALER_V4_H
#define IS_HW_API_MCSCALER_V4_H
...
void is_scaler_start(struct pablo_mmio *base_addr, u32 hw_id, u32 num_buffers, dma_addr_t clh, u32 noh);
void is_scaler_stop(struct pablo_mmio *base_addr, u32 hw_id);
void is_scaler_rdma_start(struct pablo_mmio *base_addr, u32 hw_id);
void is_scaler_set_clock(struct pablo_mmio *base_addr, bool on);
...
void is_scaler_clear_intr_all(struct pablo_mmio *base_addr, u32 hw_id);
void is_scaler_disable_intr(struct pablo_mmio *base_addr, u32 hw_id);
void is_scaler_mask_intr(struct pablo_mmio *base_addr, u32 hw_id, u32 intr_mask);
u32 is_scaler_get_mask_intr(void);

void is_scaler_get_input_status(struct pablo_mmio *base_addr, u32 hw_id, u32 *hl, u32 *vl);
...
void is_scaler_set_poly_scaler_enable(struct pablo_mmio *base_addr, u32 hw_id, u32 output_id, u32 enable);
void is_scaler_set_poly_scaler_bypass(struct pablo_mmio *base_addr, u32 output_id, u32 bypass);
...
void is_scaler_set_poly_scaler_coef(struct pablo_mmio *base_addr, u32 output_id,
...
void is_scaler_set_wdma_format(struct is_common_dma *dma, struct pablo_mmio *base_addr, u32 hw_id, u32 output_id, u32 plane, u32 dma_out_format);
void is_scaler_get_wdma_format(struct pablo_mmio *base_addr, u32 output_id, u32 color_type, u32 *dma_out_format);
void is_scaler_set_swap_mode(struct pablo_mmio *base_addr, u32 output_id, u32 swap);
...
/* for hwfc */
void is_scaler_set_hwfc_auto_clear(struct pablo_mmio *base_addr, u32 output_id, bool auto_clear);
void is_scaler_set_hwfc_idx_reset(struct pablo_mmio *base_addr, u32 output_id, bool reset);
...
void is_scaler_set_djag_tuning_param(struct pablo_mmio *base_addr,
	const struct djag_scaling_ratio_depended_config *djag_tune);
void is_scaler_set_djag_dither_wb(struct pablo_mmio *base_addr, struct djag_wb_thres_cfg *djag_wb, u32 wht, u32 blk);
...
u32 is_scaler_get_lfro_mode_status(struct pablo_mmio *base_addr, u32 hw_id);
...
/* HF */
void is_scaler_set_djag_hf_enable(struct pablo_mmio *base_addr, u32 hf_enable, u32 hf_scaler_enable);
void is_scaler_set_hf_scaler_enable(struct pablo_mmio *base_addr, u32 hw_id, u32 enable);
void is_scaler_set_djag_hf_cfg(struct pablo_mmio *base_addr, struct hf_cfg_by_ni *hf_cfg);
...
void is_scaler_dump(struct pablo_mmio *base_addr);
