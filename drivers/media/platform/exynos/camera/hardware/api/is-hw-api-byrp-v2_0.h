...
int byrp_hw_rdma_create(struct is_common_dma *dma, struct pablo_mmio *base, u32 input_id);
...
int byrp_hw_s_wdma_init(struct is_common_dma *dma, struct byrp_param_set *param_set,
	...
	u32 *sbwc_en, u32 *payload_size);
int byrp_hw_wdma_create(struct is_common_dma *dma, struct pablo_mmio *base, u32 input_id);
