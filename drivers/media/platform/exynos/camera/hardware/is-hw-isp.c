	...
	ulong hw_map)
{
	...
	cmd_input = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "ixs", hw_ip,
	...
	cmd_tnr_prev_in = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "tnr_prev_in", hw_ip,
			frame, cur_idx, frame->num_buffers,
	...
	cmd_tnr_wgt_in = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "tnr_wgt_in", hw_ip,
			frame, cur_idx, frame->num_buffers,
	...
	cmd_tnr_prev_out = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "tnr_prev_out", hw_ip,
			frame, cur_idx, frame->num_buffers,
	...
	cmd_tnr_wgt_out = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "tnr_wgt_out", hw_ip,
			frame, cur_idx, frame->num_buffers,
...
#if IS_ENABLED(USE_MCFP_MOTION_INTERFACE)
	cmd_motion = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "motion", hw_ip,
			frame, cur_idx, frame->num_buffers,
	...
	cmd_drcgrid = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "drcgrid", hw_ip,
			frame, cur_idx, frame->num_buffers,
...
#endif
#if defined(ENABLE_RGB_REPROCESSING)
	cmd_rgb_in = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "rgb_in", hw_ip,
			frame, cur_idx, frame->num_buffers,
	...
	cmd_noise_in = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "noise_in", hw_ip,
			frame, cur_idx, frame->num_buffers,
	...
	cmd_noise_rep = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "noise_rep", hw_ip,
			frame, cur_idx, frame->num_buffers,
...
#endif
#if defined(ENABLE_SC_MAP)
	cmd_scmap = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "scmap", hw_ip,
			frame, cur_idx, frame->num_buffers,
	...
	cmd_yuv = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "yuv", hw_ip,
			frame, cur_idx, frame->num_buffers,
			&param_set->dma_output_yuv.cmd,
	...
	cmd_nrds = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "nrds", hw_ip,
			frame, cur_idx, frame->num_buffers,
	...
	cmd_noise_out = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "noise_out", hw_ip,
			frame, cur_idx, frame->num_buffers,
	...
	cmd_drc = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "drc", hw_ip,
			frame, cur_idx, frame->num_buffers,
	...
	cmd_hist = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "hist", hw_ip,
			frame, cur_idx, frame->num_buffers,
	...
	dma_frame = frame;
	cmd_hf = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "hf", hw_ip,
			frame, cur_idx, frame->num_buffers,
	...
	cmd_rgb_out = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "rgb_out", hw_ip,
			frame, cur_idx, frame->num_buffers,
	...
	cmd_rgb_out = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "chk", hw_ip,
			frame, cur_idx, frame->num_buffers,
