	...
	ulong hw_map)
{
	...
	cmd_input = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "ypp", hw_ip,
	...
	cmd_input_lv2 = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "ypnrds", hw_ip,
			frame, cur_idx, frame->num_buffers,
	...
	cmd_input_noise = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "ypnoi", hw_ip,
			frame, cur_idx, frame->num_buffers,
	...
	cmd_input_hist = CALL_HW_OPS(hw_ip->hardware, dma_cfg, "ypsvhist", hw_ip,
			frame, cur_idx, frame->num_buffers,
