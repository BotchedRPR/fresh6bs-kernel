...
{
	/* share mcuctl_reg_base to cstore for test */
	void *cstore_reg_base = test_pdata.mcuctl_reg_base;

	HW_OPS(force_powerdown, test_pdata.sysctrl_reg_base, cstore_reg_base);
}
