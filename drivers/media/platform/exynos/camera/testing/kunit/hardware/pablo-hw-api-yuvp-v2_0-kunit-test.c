...
#include "hardware/sfr/is-sfr-yuvp-v2_0.h"
...
static void pablo_hw_api_yuvp_hw_is_occurred0_kunit_test(struct kunit *test)
{
	...
	u32 err_interrupt_list[] = {
		...
		INTR1_YUVP_CINFIFO_0_OVERFLOW_ERROR_INT,
		INTR1_YUVP_CINFIFO_0_OVERLAP_ERROR_INT,
		INTR1_YUVP_CINFIFO_0_PIXEL_CNT_ERROR_INT,
		INTR1_YUVP_CINFIFO_0_INPUT_PROTOCOL_ERROR_INT,
		INTR1_YUVP_COUTFIFO_0_PIXEL_CNT_ERROR_INT,
		INTR1_YUVP_COUTFIFO_0_INPUT_PROTOCOL_ERROR_INT,
		INTR1_YUVP_COUTFIFO_0_OVERFLOW_ERROR_INT,
		INTR1_YUVP_COUTFIFO_1_PIXEL_CNT_ERROR_INT,
		INTR1_YUVP_COUTFIFO_1_INPUT_PROTOCOL_ERROR_INT,
		INTR1_YUVP_COUTFIFO_1_OVERFLOW_ERROR_INT,
...
static void pablo_hw_api_yuvp_hw_is_occurred1_kunit_test(struct kunit *test)
{
	...
	u32 err_interrupt_list[] = {
		...
		INTR2_YUVP_RGB2YUV_DBG_CNT_ERR,
		INTR2_YUVP_SHARPEN_DBG_CNT_ERR,
		INTR2_YUVP_OETF_GAMMA_DBG_CNT_ERR,
		INTR2_YUVP_YUV444TO422_DBG_CNT_ERR,
		INTR2_YUVP_DITHER_DBG_CNT_ERR,
		INTR2_YUVP_SYNCFIFO_SEG_DBG_CNT_ERR,
		INTR2_YUVP_SVHIST_DBG_CNT_ERR,
		INTR2_YUVP_DGF_DBG_CNT_ERR,
		INTR2_YUVP_CNR_DBG_CNT_ERR,
		INTR2_YUVP_CLAHE_HIST_ERR,
		INTR_YUVP_DMA_R2D_CONTENTION_ERR,
	};
...
static void pablo_hw_api_yuvp_hw_s_input_path_kunit_test(struct kunit *test)
{
	...
	set_val = YUVP_GET_F(test_ctx.pmio, YUVP_R_IP_USE_OTF_PATH, YUVP_F_IP_USE_OTF_IN_FOR_PATH_0);
	expected_val = path;
	KUNIT_EXPECT_EQ(test, set_val, expected_val);
}
...
static void pablo_hw_api_yuvp_hw_s_output_path_kunit_test(struct kunit *test)
{
	...
	set_val = YUVP_GET_F(test_ctx.pmio, YUVP_R_IP_USE_OTF_PATH, YUVP_F_IP_USE_OTF_OUT_FOR_PATH_0);
	expected_val = path;
	KUNIT_EXPECT_EQ(test, set_val, expected_val);
}
