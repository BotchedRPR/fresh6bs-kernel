...
#include "hardware/sfr/is-sfr-mcsc-v11_30.h"
...
static void pablo_hw_api_mcsc_set_hwfc_config_kunit_test(struct kunit *test)
{
	...
	val = MCSC_GET_F(tctx->pmio, MCSC_R_YUV_HWFC_TOTAL_WIDTH_BYTE1_A, MCSC_F_YUV_HWFC_TOTAL_WIDTH_BYTE1_A);
	KUNIT_EXPECT_EQ(test, width >> 1, val);
	...
	val = MCSC_GET_F(tctx->pmio, MCSC_R_YUV_HWFC_TOTAL_IMAGE_BYTE0_B, MCSC_F_YUV_HWFC_TOTAL_IMAGE_BYTE0_B);
...
struct kunit_suite pablo_hw_api_mcsc_kunit_test_suite = {
	.name = "pablo-hw-api-mcsc-v11_30-kunit-test",
