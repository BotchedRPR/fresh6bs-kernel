...
#include "hardware/sfr/is-sfr-byrp-v2_0.h"
...
{
	byrp_hw_dump(test_ctx.test_addr);
}
...
static void pablo_hw_api_byrp_hw_s_core_kunit_test(struct kunit *test)
{
	...
	for (test_idx = 0; test_idx < 2; test_idx++) {
		...
		set_val = BYRP_GET_R(test_ctx.pmio, BYRP_R_BYR_OTFHDR_RATE_CONTROL_ENABLE);
...
static void pablo_hw_api_byrp_hw_is_occurred_kunit_test(struct kunit *test)
{
	...
	u32 err_interrupt0_list[BYRP_INTR0_MAX] = {
		...
		INTR0_BYRP_CINFIFO_1_OVERFLOW_ERROR_INT,
		INTR0_BYRP_CINFIFO_1_OVERLAP_ERROR_INT,
		INTR0_BYRP_CINFIFO_1_PIXEL_CNT_ERROR_INT,
		INTR0_BYRP_CINFIFO_1_INPUT_PROTOCOL_ERROR_INT,
		INTR0_BYRP_COUTFIFO_0_PIXEL_CNT_ERROR_INT,
		INTR0_BYRP_COUTFIFO_0_INPUT_PROTOCOL_ERROR_INT,
		INTR0_BYRP_COUTFIFO_0_OVERLAP_ERROR_INT,
		INTR0_BYRP_COUTFIFO_1_PIXEL_CNT_ERROR_INT,
		INTR0_BYRP_COUTFIFO_1_INPUT_PROTOCOL_ERROR_INT,
		INTR0_BYRP_COUTFIFO_1_OVERLAP_ERROR_INT,
