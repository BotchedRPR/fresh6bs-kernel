...
#include "hardware/sfr/is-sfr-rgbp-v1_20.h"
...
static void pablo_hw_api_rgbp_hw_is_occurred1_kunit_test(struct kunit *test)
{
	...
	u32 err_interrupt_list[RGBP_INTR1_MAX] = {
		INTR1_RGBP_VOTF0RDMAGLOBALERROR,
		INTR1_RGBP_VOTF1WDMAGLOBALERROR,
		INTR1_RGBP_DTP_DBG_CNT_ERROR,
		INTR1_RGBP_BDNS_DBG_CNT_ERROR,
		INTR1_RGBP_DMSC_DBG_CNT_ERROR,
		INTR1_RGBP_LSC_DBG_CNT_ERROR,
		INTR1_RGBP_RGB_GAMMA_DBG_CNT_ERROR,
		INTR1_RGBP_GTM_DBG_CNT_ERROR,
		INTR1_RGBP_RGB2YUV_DBG_CNT_ERROR,
		INTR1_RGBP_YUV444TO422_DBG_CNT_ERROR,
		INTR1_RGBP_SATFLAG_DBG_CNT_ERROR,
		INTR1_RGBP_CCM_DBG_CNT_ERROR,
		INTR1_RGBP_YUVSC_DBG_CNT_ERROR,
		INTR1_RGBP_SYNC_MERGE_COUTFIFO_DBG_CNT_ERROR,
	};
