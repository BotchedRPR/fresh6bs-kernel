...
#define IORESOURCE_CSTAT3	3
#define IORESOURCE_LME		4
#define IORESOURCE_BYRP		5
#define IORESOURCE_RGBP		6
#define IORESOURCE_MCFP		7
#define IORESOURCE_YUVP		8
#define IORESOURCE_MCSC		9
