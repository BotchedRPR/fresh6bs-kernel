...
#define CSIS_PIXEL_PER_CLK		CSIS_PPC_8
/*
 * =================================================================================================
...
#define LME_SAD_DATA_SIZE		3 /* byte */
...
#define USE_DVA_36BIT		1

#define ICPU_IO_COHERENCY	1

/* #define ENABLE_MODECHANGE_CAPTURE */

#define LOGICAL_VIDEO_NODE	1
/* #define USE_SENSOR_GROUP_LVN	1 */
...
#define CAMERA_2LD_MIRROR_FLIP	0
...
#define SBWC_STRIDE_32B_ALIGN 0x0
#define SBWC_STRIDE_64B_ALIGN 0x4
#define SBWC_BASE_ALIGN_MASK_LLC_OFF SBWC_STRIDE_32B_ALIGN
#define SBWC_BASE_ALIGN_MASK SBWC_STRIDE_64B_ALIGN
...
#define SECURE_CAMERA_MEM_SIZE		(0x03DCD200)
...
#define CHECK_NEED_KVADDR_ID(vid)	((0)					\
				...
				|| ((vid) == IS_LVN_MCFP_MV)		\
				|| ((vid) == IS_LVN_BYRP_RTA_INFO)		\
				|| ((vid) == IS_LVN_RGBP_RTA_INFO)		\
				|| ((vid) == IS_LVN_MCFP_RTA_INFO)		\
				|| ((vid) == IS_LVN_YUVP_RTA_INFO)		\
				|| ((vid) == IS_LVN_LME_RTA_INFO)		\
...
#define CLOGGING		1
#define USE_FASTEN_AE		1	/* This is a feature for fast launch to enter scenario */
/*
 * ======================================================
