...
enum sysreg_csis_reg_name {
	...
	SYSREG_R_CSIS_CSISX6_SC_PDP0_IN_EN,
	SYSREG_R_CSIS_CSISX6_SC_PDP1_IN_EN,
	SYSREG_R_CSIS_CSISX6_SC_PDP2_IN_EN,
...
enum sysreg_csis_reg_field {
	...
	SYSREG_F_CSIS_SW_RESETN_LHM_AST_GLUE_ZOTF2_TAACSIS, /* 0x440 */
	...
	SYSREG_F_CSIS_TYPE_LHM_AST_GLUE_ZOTF2_TAACSIS,
	SYSREG_F_CSIS_TYPE_LHM_AST_GLUE_ZOTF1_TAACSIS,
	SYSREG_F_CSIS_TYPE_LHM_AST_GLUE_ZOTF0_TAACSIS,
	SYSREG_F_CSIS_TYPE_LHM_AST_GLUE_SOTF2_TAACSIS,
	SYSREG_F_CSIS_TYPE_LHM_AST_GLUE_SOTF1_TAACSIS,
	SYSREG_F_CSIS_TYPE_LHM_AST_GLUE_SOTF0_TAACSIS,
	SYSREG_F_CSIS_TYPE_LHS_AST_GLUE_OTF2_CSISTAA,
	SYSREG_F_CSIS_TYPE_LHS_AST_GLUE_OTF1_CSISTAA,
	SYSREG_F_CSIS_TYPE_LHS_AST_GLUE_OTF0_CSISTAA,
	SYSREG_F_CSIS_SW_RESETN_LHM_AST_GLUE_INT_OTF2_PDPCSIS, /* 0x444 */
	...
	SYSREG_F_CSIS_TYPE_LHM_AST_GLUE_INT_OTF2_PDPCSIS,
	SYSREG_F_CSIS_TYPE_LHM_AST_GLUE_INT_OTF1_PDPCSIS,
	SYSREG_F_CSIS_TYPE_LHM_AST_GLUE_INT_OTF0_PDPCSIS,
	SYSREG_F_CSIS_TYPE_LHS_AST_GLUE_INT_OTF2_PDPCSIS,
	SYSREG_F_CSIS_TYPE_LHS_AST_GLUE_INT_OTF1_PDPCSIS,
	SYSREG_F_CSIS_TYPE_LHS_AST_GLUE_INT_OTF0_PDPCSIS,
	SYSREG_F_CSIS_TYPE_LHM_AST_GLUE_INT_OTF2_CSISPDP,
	SYSREG_F_CSIS_TYPE_LHM_AST_GLUE_INT_OTF1_CSISPDP,
	SYSREG_F_CSIS_TYPE_LHM_AST_GLUE_INT_OTF0_CSISPDP,
	SYSREG_F_CSIS_TYPE_LHS_AST_GLUE_INT_OTF2_CSISPDP,
	SYSREG_F_CSIS_TYPE_LHS_AST_GLUE_INT_OTF1_CSISPDP,
	SYSREG_F_CSIS_TYPE_LHS_AST_GLUE_INT_OTF0_CSISPDP,
	SYSREG_F_CSIS_PDP0_IN_CSIS5_EN, /* 0x480 ~ 0x488 */
	...
	SYSREG_F_CSIS_FRAME_ID_EN_CSIS, /* 0x4a0 ~ 0x4b4 */
	SYSREG_F_CSIS_FID_LOC_LINE,
	SYSREG_F_CSIS_FID_LOC_BYTE,
	SYSREG_F_CSIS_MIPI_DPHY_CONFIG, /* 0x500 */
...
enum sysreg_taa_reg_field {
	...
	SYSREG_F_TAA_SW_RESETN_LHS_AST_GLUE_OTF_TAADNS,  /* 0x400 */
	...
	SYSREG_F_TAA_GLUEMUX_OTFOUT_SEL_0,  /* 0x404 */
	SYSREG_F_TAA_LHS_AST_OTF_TAADNS,  /* 0x408 */
...
enum sysreg_tnr_reg_field {
	SYSREG_F_MCFP0_EN, /* 0x108 */
	SYSREG_TNR_REG_FIELD_CNT
};

enum sysreg_dns_reg_field {
	SYSREG_F_DNS_EN, /* 0x108 */
	SYSREG_F_DNS_GLUEMUX_DNS0_VAL, /* 0x400 */
	SYSREG_F_DNS_AxCACHE_DNS1_VOTF,
	SYSREG_F_DNS_AXCACHE_DNS1_DMA,
	SYSREG_F_DNS_AXCACHE_DNS0_DMA,
	SYSREG_F_DNS_ENABLE_OTF5_IN_ITPDNS, /* 0x404 */
	...
	SYSREG_F_DNS_ENABLE_OTF_IN_TNRDNS,
	SYSREG_F_DNS_ENABLE_OTF_IN_TAADNS,
	SYSREG_F_DNS_TYPE_LHM_AST_GLUE_OTF_TNRDNS,
	SYSREG_F_DNS_TYPE_LHM_AST_GLUE_OTF_TAADNS,
	SYSREG_F_DNS_SW_RESETN_LHM_AST_GLUE_OTF_TNRDNS,
	SYSREG_F_DNS_SW_RESETN_LHM_AST_GLUE_OTF_TAADNS,
	SYSREG_DNS_REG_FIELD_CNT
};

enum sysreg_itp_reg_field {
	SYSREG_F_ITP_EN, /* 0x108 */
	SYSREG_F_ITP_SW_RESETN_LHS_AST_GLUE_OTF_ITPMCSC, /* 0x400 */
	SYSREG_F_ITP_TYPE_LHS_AST_GLUE_OTF_ITPMCSC,
	SYSREG_F_ITP_SW_RESETN_LHM_AST_GLUE_OTF_TNRITP,
	SYSREG_F_ITP_TYPE_LHM_AST_GLUE_OTF_TNRITP,
	SYSREG_F_ITP_ENABLE_OTF_OUT_ITPMCSC,
	SYSREG_F_ITP_ENABLE_OTF_IN_TNRITP,
	SYSREG_F_ITP_ENABLE_OTF5_OUT_ITPDNS,
...
enum sysreg_yuvpp_reg_field {
	SYSREG_F_YUVPP_EN, /* 0x108 */
	SYSREG_F_YUVPP_SW_RESETN_LHS_AST_GLUE_OTF_YUVPPMCSC, /* 0x414 */
...
enum sysreg_mcsc_reg_field {
	...
	SYSREG_F_MCSC_YUVPP_ITP_OTFDATA_TO_MCSC_MUXSEL, /* 0x408 */
	SYSREG_F_MCSC_SW_RESETN_LHM_AST_GLUE_OTF_ITPMCSC,
	SYSREG_F_MCSC_TYPE_LHM_AST_GLUE_OTF_ITPMCSC,
	SYSREG_F_MCSC_ENABLE_OTF_IN_LHM_AST_OTF_ITPMCSC,
...
#define IORESOURCE_ORBMCH0	8
#define IORESOURCE_ORBMCH1	9
#define IORESOURCE_ITP		10
#define IORESOURCE_TNR0		11
#define IORESOURCE_TNR1		12
#define IORESOURCE_DNS		13
#define IORESOURCE_YUVPP	14
...
/* ORBMCH DMA: 5184080 byte for 5ea preview, not supported in still tnr */
/* Key/Desc size */
/* (((ORB_KPT_BUFFER_SIZE + ORB_DESC_BUFFER_SIZE) * ORB_MCH_MAX_BUF_NUM) + DMA_ALIGNMENT_BYTES) X preview_cnt */
/* (((16*300*9 + 16*300*9*2) * 8) + 16) x 5 */
#define TAAISP_ORBMCH_SIZE	(0x004F1A50)
...
/* LME: TBD(1KB) */
#define TAAISP_LME_SIZE		(0x00001000)
...
#define SYSREG_TAA_BASE_ADDR	(0x17420000)
#define SYSREG_TNR_BASE_ADDR	(0x17820000)
#define SYSREG_ITP_BASE_ADDR	(0x17A20000)
#define SYSREG_DNS_BASE_ADDR	(0x17620000)
#define SYSREG_YUVPP_BASE_ADDR	(0x17E20000)
#define SYSREG_MCSC_BASE_ADDR	(0x17B20000)

#define HWFC_INDEX_RESET_ADDR	(0x17B61050)
...
enum pablo_video_probe_num {
	...
	PABLO_VIDEO_PROBE_YPP,
	PABLO_VIDEO_PROBE_M0S,
	PABLO_VIDEO_PROBE_LME0,
	PABLO_VIDEO_PROBE_LME1,
