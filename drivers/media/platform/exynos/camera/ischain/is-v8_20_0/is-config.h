...
#define SECURE_CAMERA_TAAISP		1
#define SECURE_CAMERA_MEDRC		1
...
#define PROTECT_SYSREG_IS		1 /* If sysreg_is needs to be protected in secure scenario */

#define SECURE_CAMERA_USE_EXT_HEAP	1
