...
#include "pablo-hw-reg-gdc-v1000.h"
...
const struct gdc_variant *camerapp_hw_gdc_get_size_constraints(struct pablo_mmio *pmio)
{
	...
	u32 version = GDC_GET_R(pmio, &gdc_regs[GDC_R_IP_VERSION]);
...
{
	return GDC_GET_R(pmio, &gdc_regs[GDC_R_IP_VERSION]);
}

void camerapp_hw_gdc_start(struct pablo_mmio *pmio, struct c_loader_buffer *clb)
{
	/* oneshot */
	GDC_SET_F(pmio, &gdc_regs[GDC_R_CMDQ_ADD_TO_QUEUE_0],
		&gdc_fields[GDC_F_CMDQ_ADD_TO_QUEUE_0], 0x1);
	GDC_SET_F(pmio, &gdc_regs[GDC_R_IP_PROCESSING],
...
u32 camerapp_hw_gdc_sw_reset(struct pablo_mmio *pmio)
{
	...
	do {
		...
		if (reset_count > 10000)
			return reset_count;
	} while (GDC_GET_F(pmio, &gdc_regs[GDC_R_SW_RESET],
...
{
	GDC_SET_F(pmio, &gdc_regs[GDC_R_INT_REQ_INT0_CLEAR],
		&gdc_fields[GDC_F_INT_REQ_INT0_CLEAR], GDC_INT0_EN);
	GDC_SET_F(pmio, &gdc_regs[GDC_R_INT_REQ_INT1_CLEAR],
...
static void camerapp_hw_gdc_set_rdma_enable(struct pablo_mmio *pmio,
	u32 en_y, u32 en_uv)
{
	GDC_SET_F(pmio, &gdc_regs[GDC_R_YUV_RDMAY_EN],
		&gdc_fields[GDC_F_YUV_RDMAY_EN], en_y);
	GDC_SET_F(pmio, &gdc_regs[GDC_R_YUV_RDMAUV_EN],
		&gdc_fields[GDC_F_YUV_RDMAUV_EN], en_uv);
}

static void camerapp_hw_gdc_set_wdma_enable(struct pablo_mmio *pmio,
	u32 enable)
{
	GDC_SET_F(pmio, &gdc_regs[GDC_R_YUV_WDMA_EN],
		&gdc_fields[GDC_F_YUV_WDMA_EN], enable);
}

static void camerapp_hw_gdc_set_rdma_sbwc_enable(struct pablo_mmio *pmio,
	u32 enable)
{
	GDC_SET_F(pmio,
...
static void camerapp_hw_gdc_set_wdma_sbwc_enable(struct pablo_mmio *pmio,
	u32 enable)
{
	GDC_SET_F(pmio,
...
static void camerapp_hw_gdc_set_rdma_sbwc_64b_align(struct pablo_mmio *pmio,
	u32 align_64b)
{
	/*
	 * align_64b
...
static void camerapp_hw_gdc_set_wdma_sbwc_64b_align(struct pablo_mmio *pmio,
	u32 align_64b)
{
	/*
	 * align_64b
...
static void camerapp_hw_gdc_set_rdma_data_format(struct pablo_mmio *pmio,
	u32 yuv_format)
{
	GDC_SET_F(pmio, &gdc_regs[GDC_R_YUV_RDMAY_DATA_FORMAT],
		&gdc_fields[GDC_F_YUV_RDMAY_DATA_FORMAT_YUV], yuv_format);
	GDC_SET_F(pmio, &gdc_regs[GDC_R_YUV_RDMAUV_DATA_FORMAT],
		&gdc_fields[GDC_F_YUV_RDMAUV_DATA_FORMAT_YUV], yuv_format);
}

static void camerapp_hw_gdc_set_wdma_data_format(struct pablo_mmio *pmio,
	u32 yuv_format)
{
	GDC_SET_F(pmio, &gdc_regs[GDC_R_YUV_WDMA_DATA_FORMAT],
		&gdc_fields[GDC_F_YUV_WDMA_DATA_FORMAT_YUV], yuv_format);
}

static void camerapp_hw_gdc_set_wdma_mono_mode(struct pablo_mmio *pmio,
	u32 mode)
{
	GDC_SET_F(pmio, &gdc_regs[GDC_R_YUV_WDMA_MONO_MODE],
	...
	u32 width, u32 height)
{
	...
	GDC_SET_F(pmio, &gdc_regs[GDC_R_YUV_RDMAY_WIDTH],
		&gdc_fields[GDC_F_YUV_RDMAY_WIDTH], width);
	GDC_SET_F(pmio, &gdc_regs[GDC_R_YUV_RDMAY_HEIGHT],
		&gdc_fields[GDC_F_YUV_RDMAY_HEIGHT], height);

	GDC_SET_F(pmio, &gdc_regs[GDC_R_YUV_RDMAUV_WIDTH],
		&gdc_fields[GDC_F_YUV_RDMAUV_WIDTH], width);

	yuv_format = GDC_GET_F(pmio,
	...
	GDC_SET_F(pmio, &gdc_regs[GDC_R_YUV_RDMAUV_HEIGHT],
...
static void camerapp_hw_gdc_set_wdma_img_size(struct pablo_mmio *pmio,
	u32 width, u32 height)
{
	GDC_SET_F(pmio, &gdc_regs[GDC_R_YUV_WDMA_WIDTH],
		&gdc_fields[GDC_F_YUV_WDMA_WIDTH], width);
	GDC_SET_F(pmio, &gdc_regs[GDC_R_YUV_WDMA_HEIGHT],
...
void camerapp_hw_gdc_set_initialization(struct pablo_mmio *pmio)
{
	...
	GDC_SET_F(pmio, &gdc_regs[GDC_R_C_LOADER_ENABLE],
		&gdc_fields[GDC_F_C_LOADER_ENABLE], 0x0);
	GDC_SET_F(pmio, &gdc_regs[GDC_R_STAT_RDMACLOADER_EN],
		&gdc_fields[GDC_F_STAT_RDMACLOADER_EN], 0x0);
	GDC_SET_F(pmio, &gdc_regs[GDC_R_INT_REQ_INT0_ENABLE],
		&gdc_fields[GDC_F_INT_REQ_INT0_ENABLE], GDC_INT0_EN);
	GDC_SET_F(pmio, &gdc_regs[GDC_R_INT_REQ_INT1_ENABLE],
		&gdc_fields[GDC_F_INT_REQ_INT1_ENABLE], GDC_INT1_EN);
	GDC_SET_F(pmio, &gdc_regs[GDC_R_CMDQ_ENABLE],
		&gdc_fields[GDC_F_CMDQ_ENABLE], 0x1);
}

static void camerapp_hw_gdc_set_mode(struct pablo_mmio *pmio, u32 mode)
{
	GDC_SET_F(pmio, &gdc_regs[GDC_R_CMDQ_QUE_CMD_H],
		&gdc_fields[GDC_F_CMDQ_QUE_CMD_BASE_ADDR], 0x0);
	GDC_SET_F(pmio, &gdc_regs[GDC_R_CMDQ_QUE_CMD_M],
	...
	GDC_SET_F(pmio, &gdc_regs[GDC_R_CMDQ_QUE_CMD_L],
	...
	struct gdc_crop_param *crop_param)
{
	...
	GDC_SET_F(pmio, &gdc_regs[GDC_R_YUV_GDC_OUT_CROP_SIZE],
	...
	GDC_SET_F(pmio, &gdc_regs[GDC_R_YUV_GDC_OUT_SCALE],
	...
	struct gdc_frame *s_frame, struct gdc_frame *d_frame)
{
	...
	if (mono_format) {
		...
		GDC_SET_F(pmio, &gdc_regs[GDC_R_YUV_GDC_YUV_FORMAT],
			&gdc_fields[GDC_F_YUV_GDC_MONO_MODE], mono_format);
		camerapp_hw_gdc_set_wdma_mono_mode(pmio, mono_format);
		return;
	}
	...
	struct gdc_crop_param *crop_param)
{
	...
	input_bit_depth = GDC_GET_F(pmio,
		&gdc_regs[GDC_R_YUV_GDC_YUV_FORMAT],
	...
	struct gdc_frame *s_frame, struct gdc_frame *d_frame)
{
	...
	if (s_comp_type) {
		GDC_SET_F(pmio, &gdc_regs[GDC_R_YUV_GDC_COMPRESSOR],
...
int camerapp_hw_get_sbwc_constraint(u32 pixelformat, u32 width, u32 height, u32 type)
{
	...
	/* Size align */
	if (!IS_ALIGNED(width, GDC_COMP_BLOCK_WIDTH) ||
		!IS_ALIGNED(height, GDC_COMP_BLOCK_HEIGHT)) {
		gdc_info("%dx%d of target image is not aligned by %d*%d\n",
			width, height,
			GDC_COMP_BLOCK_WIDTH, GDC_COMP_BLOCK_HEIGHT);
		return -EINVAL;
	}
	return 0;
}
...
void camerapp_hw_gdc_update_param(struct pablo_mmio *pmio, struct gdc_dev *gdc)
{
	...
	camerapp_hw_gdc_set_mode(pmio, 0x3); /* apb direct....*/
	...
	camerapp_hw_gdc_update_dma_size(pmio,
