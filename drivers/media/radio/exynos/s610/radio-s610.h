...
#ifndef CONFIG_SOC_EXYNOS8535
#define CONFIG_SOC_EXYNOS8535
#endif

#ifndef CONFIG_RADIO_S620
#define CONFIG_RADIO_S620
#endif
...
#ifdef USE_PMIC_RW
	int fm_pmic;
	struct i2c_client *i2c_main1;
	struct i2c_client *i2c_main2;
...
#ifdef USE_PMIC_RW
extern int s2mpu15_read_reg(struct i2c_client *i2c, u8 reg, u8 *dest);
extern int s2mpu15_write_reg(struct i2c_client *i2c, u8 reg, u8 value);
extern int s2mpa05_read_reg(struct i2c_client *i2c, u8 reg, u8 *dest);
extern int s2mpa05_write_reg(struct i2c_client *i2c, u8 reg, u8 value);
#endif
