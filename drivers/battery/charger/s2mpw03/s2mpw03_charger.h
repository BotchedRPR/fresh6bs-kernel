...
#define S2MPW03_CHG_REG_SHIP_MODE_CTRL1 0x4B
#define S2MPW03_CHG_REG_SHIP_MODE_CTRL2 0x4C
...
/* S2MPW03_CHG_SHIP_MODE_CTRL1 */
#define CHG_SHIP_MODE_CTRL1_SHIFT		0
#define CHG_SHIP_MODE_CTRL1_MASK			BIT(CHG_SHIP_MODE_CTRL1_SHIFT)

/* S2MPW03_CHG_SHIP_MODE_CTRL1 */
#define CHG_SHIP_MODE_CTRL2_SHIFT		4
#define CHG_SHIP_MODE_CTRL2_WIDTH	3
#define CHG_SHIP_MODE_CTRL2_MASK			MASK(CHG_SHIP_MODE_CTRL2_WIDTH, CHG_SHIP_MODE_CTRL2_SHIFT)


enum {
	SHIPMODE_DB_TIME_4S = 1,
	SHIPMODE_DB_TIME_8S,
	SHIPMODE_DB_TIME_16S,
	SHIPMODE_DB_TIME_32S,
};
...
struct s2mpw03_muic;
#if IS_ENABLED(CONFIG_MUIC_S2MPW03)
struct s2mpw03_muic *s2mpw03_init_muic(struct platform_device *pdev);
void s2mpw03_muic_unregister(struct s2mpw03_muic *muic);
#else
static inline struct s2mpw03_muic *s2mpw03_init_muic(struct platform_device *pdev)
{ return NULL; }
static inline void s2mpw03_muic_unregister(struct s2mpw03_muic *muic)
{}
#endif
