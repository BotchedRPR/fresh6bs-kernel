#ifndef __ZTM730_MOTOR_H__
#define __ZTM730_MOTOR_H__
/*
** =============================================================================
**
...
**
** Description:
**     Header file for ztm730_motor.c
**
** =============================================================================
*/
...
#define HAPTICS_DEVICE_NAME "ztm730_motor"
...
struct ztm730_motor_data {
	...
	struct notifier_block ztm730_motor_pm_nb;
	struct i2c_client *client;
	struct ztm730_motor_pdata *msPlatData;
	struct regulator *regulator;
	struct wakeup_source *ws;
	struct work_struct vibrator_work;
	struct work_struct delay_en_off;
	struct work_struct trigger_init;
	struct work_struct fifo_vib_work;
	struct mutex lock;
