...
#if IS_ENABLED(CONFIG_SCSC_PCIE_PAEAN_X86) || IS_ENABLED(CONFIG_SOC_S5E9925) || IS_ENABLED(CONFIG_SOC_S5E9935)
...
#if defined(CONFIG_SOC_S5E9815) || defined(CONFIG_SOC_S5E9925) || IS_ENABLED(CONFIG_SOC_S5E9935)
...
/* To un/register callbacks to mxman functionality */
...
#if defined(CONFIG_SCSC_INDEPENDENT_SUBSYSTEM)
#if defined(CONFIG_SCSC_PCIE_PAEAN_X86) || defined(CONFIG_SOC_S5E9925) || IS_ENABLED(CONFIG_SOC_S5E9935)
	void __iomem *(*get_scoreboard)(struct scsc_mif_abs *interface);
	int (*get_scoreboard_ref)(struct scsc_mif_abs *interface, __iomem void *addr, uintptr_t *addr_ref);
#endif
	...
	int (*hcf_ver_read)(struct scsc_mif_abs *interface, u32 *value);
