...
#define	I3C_EXTCAP_HDR_7			0x2194
...
static void exynos_i3c_hci_master_upd_i3c_addr(struct i3c_dev_desc *dev)
{
	...
	if (dev->info.dyn_addr) {
		...
		dat &= ~(I3C_STATIC_ADDRESS_MASK | I3C_DYNAMIC_ADDRESS_MASK | I3C_DEVICE_TYPE);
...
//	unsigned int queue_thld, buffer_thld;
	...
	writel(0x20, master->regs + I3C_EXT_RESET_CTRL);
