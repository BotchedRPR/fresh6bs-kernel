...
#include "./cal_5515/regs-dpp.h"
#include "./cal_5515/dpp_cal.h"

extern int dpp_log_level;

#define DPP_MODULE_NAME		"exynos-dpp"

#define MAX_DPP_CNT		MAX_DPP_SUBDEV /* + ODMA case */
#define SOC_DPP_CNT		MAX_DPP_SUBDEV /* + ODMA case */
...
struct dpp_restrictions_info {
	...
	struct dpp_ch_restriction dpp_ch[7];
	int dpp_cnt;
	u32 reserved[4];
};
