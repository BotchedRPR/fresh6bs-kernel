...
#include "./cal_5515/regs-decon.h"
#include "./cal_5515/decon_cal.h"
...
#include "mcd.h"
#include "panels/panel_drv_header.h"
#endif

#if IS_ENABLED(CONFIG_EXYNOS_LPD)
#include "../../../../staging/lpd/lpd_fw.h"
#endif
...
#if IS_ENABLED(CONFIG_EXYNOS_LPD)
	struct pinctrl_state *disp_rstn_ret_on;
	struct pinctrl_state *disp_rstn_ret_off;
#endif
};
...
#if IS_ENABLED(CONFIG_USDM_PANEL)
	struct dentry *debug_decon;
	struct dentry *debug_panel_cmd_log;
	struct dentry *debug_vrr;
#endif
...
#endif /* CONFIG_EXYNOS_DOZE_HIBERNATION */
...
#if defined(CONFIG_EXYNOS_DOZE) && IS_ENABLED(CONFIG_USDM_PANEL)
