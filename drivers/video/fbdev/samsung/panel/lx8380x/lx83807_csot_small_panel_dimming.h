/*
 * linux/drivers/video/fbdev/exynos/panel/s6e36w5x01/lx83807_csot_panel_dimming.h
 *
 ...
 * PANEL : BOE
 */
static unsigned int lx83807_csot_brt_tbl[LX8380X_TOTAL_STEP] = {
	// normal 255
...
static unsigned int lx83807_csot_lum_tbl[LX8380X_TOTAL_NR_LUMINANCE] = {
	// normal 255
...
static unsigned int lx83807_csot_step_cnt_tbl[LX8380X_TOTAL_STEP] = {
	[0 ... LX8380X_TOTAL_STEP - 1] = 1,
};

static struct brightness_table lx83807_csot_panel_brightness_table = {
	.control_type = BRIGHTNESS_CONTROL_TYPE_GAMMA_MODE2,
	.brt = lx83807_csot_brt_tbl,
	.sz_brt = ARRAY_SIZE(lx83807_csot_brt_tbl),
	.sz_ui_brt = LX8380X_NR_STEP,
	.sz_hbm_brt = LX8380X_HBM_STEP,
	.lum = lx83807_csot_lum_tbl,
	...
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = lx83807_csot_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(lx83807_csot_step_cnt_tbl),
	.vtotal = 3232,
};

static struct panel_dimming_info lx83807_csot_panel_dimming_info = {
	.name = "lx83807_csot",
	.dim_init_info = {
		NULL,
	},
	...
	.brt_tbl = &lx83807_csot_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,
	.hbm_aor = NULL,
