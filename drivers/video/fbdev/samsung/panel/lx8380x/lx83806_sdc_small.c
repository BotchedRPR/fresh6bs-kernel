...
#include "lx83806_sdc_small_panel.h"
...
int lx83806_sdc_small_maptbl_init_red_gamma_5nit(struct maptbl *tbl)
{
...
void lx83806_sdc_small_maptbl_copy_red_gamma_5nit(struct maptbl *tbl, u8 *dst)
{
	struct panel_device *panel;
	u8 mtp_red[2] = { 0x00, };
	u16 red_default = 0;
	...
	offset_result = red_default - LX83806_SDC_SMALL_RED_GAMMA_5NIT_DEFAULT_1;
	if (offset_result < 0) {
	...
	offset_result = red_default - LX83806_SDC_SMALL_RED_GAMMA_5NIT_DEFAULT_2;
	if (offset_result < 0) {
	...
	offset_result = red_default - LX83806_SDC_SMALL_RED_GAMMA_5NIT_DEFAULT_3;
	if (offset_result < 0) {
	...
	offset_result = red_default - LX83806_SDC_SMALL_RED_GAMMA_5NIT_DEFAULT_4;
	if (offset_result < 0) {
	...
	offset_result = red_default - LX83806_SDC_SMALL_RED_GAMMA_5NIT_DEFAULT_5;
	if (offset_result < 0) {
...
int lx83806_sdc_small_maptbl_init_green_gamma_5nit(struct maptbl *tbl)
{
	struct panel_info *panel_data;
	struct panel_device *panel;
...
void lx83806_sdc_small_maptbl_copy_green_gamma_5nit(struct maptbl *tbl, u8 *dst)
{
	struct panel_device *panel;
	u8 mtp_green[2] = { 0x00, };
	u16 green_default = 0;
	...
	offset_result = green_default - LX83806_SDC_SMALL_GREEN_GAMMA_5NIT_DEFAULT_1;
	if (offset_result < 0) {
		panel_warn("offset1 is negative(%d -> 0)\n", offset_result);
		offset_result = 0;
	}
	...
	offset_result = green_default - LX83806_SDC_SMALL_GREEN_GAMMA_5NIT_DEFAULT_2;
	if (offset_result < 0) {
		panel_warn("offset2 is negative(%d -> 0)\n", offset_result);
		offset_result = 0;
	}
	...
	offset_result = green_default - LX83806_SDC_SMALL_GREEN_GAMMA_5NIT_DEFAULT_3;
	if (offset_result < 0) {
		panel_warn("offset3 is negative(%d -> 0)\n", offset_result);
		offset_result = 0;
	}
	...
	offset_result = green_default - LX83806_SDC_SMALL_GREEN_GAMMA_5NIT_DEFAULT_4;
	if (offset_result < 0) {
		panel_warn("offset4 is negative(%d -> 0)\n", offset_result);
		offset_result = 0;
	}
	...
	offset_result = green_default - LX83806_SDC_SMALL_GREEN_GAMMA_5NIT_DEFAULT_5;
	if (offset_result < 0) {
		panel_warn("offset5 is negative(%d -> 0)\n", offset_result);
		offset_result = 0;
	}
...
int lx83806_sdc_small_maptbl_init_blue_gamma_5nit(struct maptbl *tbl)
{
	struct panel_info *panel_data;
	struct panel_device *panel;
...
void lx83806_sdc_small_maptbl_copy_blue_gamma_5nit(struct maptbl *tbl, u8 *dst)
{
	struct panel_device *panel;
	u8 mtp_blue[2] = { 0x00, };
	u16 blue_default = 0;
	...
	offset_result = blue_default - LX83806_SDC_SMALL_BLUE_GAMMA_5NIT_DEFAULT_1;
	if (offset_result < 0) {
		panel_warn("offset1 is negative(%d -> 0)\n", offset_result);
		offset_result = 0;
	}
	...
	offset_result = blue_default - LX83806_SDC_SMALL_BLUE_GAMMA_5NIT_DEFAULT_2;
	if (offset_result < 0) {
		panel_warn("offset2 is negative(%d -> 0)\n", offset_result);
		offset_result = 0;
	}
	...
	offset_result = blue_default - LX83806_SDC_SMALL_BLUE_GAMMA_5NIT_DEFAULT_3;
	if (offset_result < 0) {
		panel_warn("offset3 is negative(%d -> 0)\n", offset_result);
		offset_result = 0;
	}
	...
	offset_result = blue_default - LX83806_SDC_SMALL_BLUE_GAMMA_5NIT_DEFAULT_4;
	if (offset_result < 0) {
		panel_warn("offset4 is negative(%d -> 0)\n", offset_result);
		offset_result = 0;
	}
	...
	offset_result = blue_default - LX83806_SDC_SMALL_BLUE_GAMMA_5NIT_DEFAULT_5;
	if (offset_result < 0) {
		panel_warn("offset5 is negative(%d -> 0)\n", offset_result);
		offset_result = 0;
	}
...
int lx83806_sdc_small_maptbl_init_red_gamma_600nit(struct maptbl *tbl)
{
	struct panel_info *panel_data;
	struct panel_device *panel;
	u8 mtp_red_try1[2], mtp_red_try2[2], mtp_red_try3[2];
...
void lx83806_sdc_small_maptbl_copy_red_gamma_600nit(struct maptbl *tbl, u8 *dst)
{
	struct panel_device *panel;
	u8 mtp_red[2] = { 0x00, };
	u16 red_default = 0;
	...
	offset_result = red_default - LX83806_SDC_SMALL_RED_GAMMA_600NIT_DEFAULT;
	if (offset_result < 0) {
		panel_warn("offset1 is negative(%d -> 0)\n", offset_result);
		offset_result = 0;
	}
...
int lx83806_sdc_small_maptbl_init_green_gamma_600nit(struct maptbl *tbl)
{
	struct panel_info *panel_data;
	struct panel_device *panel;
	u8 mtp_green_try1[2], mtp_green_try2[2], mtp_green_try3[2];
...
void lx83806_sdc_small_maptbl_copy_green_gamma_600nit(struct maptbl *tbl, u8 *dst)
{
	struct panel_device *panel;
	u8 mtp_green[2] = { 0x00, };
	u16 green_default = 0;
	...
	offset_result = green_default - LX83806_SDC_SMALL_GREEN_GAMMA_600NIT_DEFAULT;
	if (offset_result < 0) {
		panel_warn("offset1 is negative(%d -> 0)\n", offset_result);
		offset_result = 0;
	}
...
int lx83806_sdc_small_maptbl_init_blue_gamma_600nit(struct maptbl *tbl)
{
	struct panel_info *panel_data;
	struct panel_device *panel;
	u8 mtp_blue_try1[2], mtp_blue_try2[2], mtp_blue_try3[2];
...
void lx83806_sdc_small_maptbl_copy_blue_gamma_600nit(struct maptbl *tbl, u8 *dst)
{
	struct panel_device *panel;
	u8 mtp_blue[2] = { 0x00, };
	u16 blue_default = 0;
	...
	offset_result = blue_default - LX83806_SDC_SMALL_BLUE_GAMMA_600NIT_DEFAULT;
	if (offset_result < 0) {
		panel_warn("offset1 is negative(%d -> 0)\n", offset_result);
		offset_result = 0;
	}
...
struct pnobj_func lx83806_sdc_small_function_table[MAX_LX83806_SDC_SMALL_FUNCTION] = {
	[LX83806_SDC_SMALL_MAPTBL_INIT_RED_GAMMA_5NIT] = __PNOBJ_FUNC_INITIALIZER(LX83806_SDC_SMALL_MAPTBL_INIT_RED_GAMMA_5NIT, lx83806_sdc_small_maptbl_init_red_gamma_5nit),
	[LX83806_SDC_SMALL_MAPTBL_INIT_GREEN_GAMMA_5NIT] = __PNOBJ_FUNC_INITIALIZER(LX83806_SDC_SMALL_MAPTBL_INIT_GREEN_GAMMA_5NIT, lx83806_sdc_small_maptbl_init_green_gamma_5nit),
	[LX83806_SDC_SMALL_MAPTBL_INIT_BLUE_GAMMA_5NIT] = __PNOBJ_FUNC_INITIALIZER(LX83806_SDC_SMALL_MAPTBL_INIT_BLUE_GAMMA_5NIT, lx83806_sdc_small_maptbl_init_blue_gamma_5nit),
	[LX83806_SDC_SMALL_MAPTBL_INIT_RED_GAMMA_600NIT] = __PNOBJ_FUNC_INITIALIZER(LX83806_SDC_SMALL_MAPTBL_INIT_RED_GAMMA_600NIT, lx83806_sdc_small_maptbl_init_red_gamma_600nit),
	[LX83806_SDC_SMALL_MAPTBL_INIT_GREEN_GAMMA_600NIT] = __PNOBJ_FUNC_INITIALIZER(LX83806_SDC_SMALL_MAPTBL_INIT_GREEN_GAMMA_600NIT, lx83806_sdc_small_maptbl_init_green_gamma_600nit),
	[LX83806_SDC_SMALL_MAPTBL_INIT_BLUE_GAMMA_600NIT] = __PNOBJ_FUNC_INITIALIZER(LX83806_SDC_SMALL_MAPTBL_INIT_BLUE_GAMMA_600NIT, lx83806_sdc_small_maptbl_init_blue_gamma_600nit),
	[LX83806_SDC_SMALL_MAPTBL_COPY_RED_GAMMA_5NIT] = __PNOBJ_FUNC_INITIALIZER(LX83806_SDC_SMALL_MAPTBL_COPY_RED_GAMMA_5NIT, lx83806_sdc_small_maptbl_copy_red_gamma_5nit),
	[LX83806_SDC_SMALL_MAPTBL_COPY_GREEN_GAMMA_5NIT] = __PNOBJ_FUNC_INITIALIZER(LX83806_SDC_SMALL_MAPTBL_COPY_GREEN_GAMMA_5NIT, lx83806_sdc_small_maptbl_copy_green_gamma_5nit),
	[LX83806_SDC_SMALL_MAPTBL_COPY_BLUE_GAMMA_5NIT] = __PNOBJ_FUNC_INITIALIZER(LX83806_SDC_SMALL_MAPTBL_COPY_BLUE_GAMMA_5NIT, lx83806_sdc_small_maptbl_copy_blue_gamma_5nit),
	[LX83806_SDC_SMALL_MAPTBL_COPY_RED_GAMMA_600NIT] = __PNOBJ_FUNC_INITIALIZER(LX83806_SDC_SMALL_MAPTBL_COPY_RED_GAMMA_600NIT, lx83806_sdc_small_maptbl_copy_red_gamma_600nit),
	[LX83806_SDC_SMALL_MAPTBL_COPY_GREEN_GAMMA_600NIT] = __PNOBJ_FUNC_INITIALIZER(LX83806_SDC_SMALL_MAPTBL_COPY_GREEN_GAMMA_600NIT, lx83806_sdc_small_maptbl_copy_green_gamma_600nit),
	[LX83806_SDC_SMALL_MAPTBL_COPY_BLUE_GAMMA_600NIT] = __PNOBJ_FUNC_INITIALIZER(LX83806_SDC_SMALL_MAPTBL_COPY_BLUE_GAMMA_600NIT, lx83806_sdc_small_maptbl_copy_blue_gamma_600nit),
};

static int __init lx83806_sdc_small_panel_init(void)
{
	lx8380x_init();
	panel_function_insert_array(lx83806_sdc_small_function_table, ARRAY_SIZE(lx83806_sdc_small_function_table));
	register_common_panel(&lx83806_sdc_small_panel_info);

	return 0;
}

static void __exit lx83806_sdc_small_panel_exit(void)
{
	deregister_common_panel(&lx83806_sdc_small_panel_info);
}

module_init(lx83806_sdc_small_panel_init)
module_exit(lx83806_sdc_small_panel_exit)
