...
#if IS_ENABLED(CONFIG_SOC_S5E9925) || IS_ENABLED(CONFIG_SOC_S5E9935)
#define FIN_HZ			(76.8*MHZ)
#elif IS_ENABLED(CONFIG_SOC_S5E8535)
#define FIN_HZ			(52*MHZ)
...
extern unsigned long ra_recalc_rate(unsigned int id);
extern unsigned long ra_get_value(unsigned int id);
