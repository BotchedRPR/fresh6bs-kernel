...
struct pmucal_seq lpd_sram_off[] = {
	// PGEN set
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "MEMORY_CTRL_CHUB_OUT", 0x12860000, 0x3fa0, (0x70 << 0), (0x70 << 0), 0, 0, 0xffffffff, 0),
	// PGEN__FEEDBACK
	PMUCAL_SEQ_DESC(PMUCAL_WAIT, "MEMORY_CTRL_CHUB_IN", 0x12860000, 0x3fa4, (0x70 << 0), (0x70 << 0), 0, 0, 0xffffffff, 0),
};
