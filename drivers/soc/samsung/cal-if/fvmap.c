...
static int margin_npu0;
static int margin_npu1;
...
module_param(margin_npu0, int, 0);
module_param(margin_npu1, int, 0);
...
void margin_table_init(void)
{
	...
	init_margin_table[MARGIN_MFD] = margin_mfd;
	init_margin_table[MARGIN_NPU1] = margin_npu1;
	init_margin_table[MARGIN_NPU0] = margin_npu0;
