...
static struct pll_spec frd4601ipll_spec = {
	1,		63,
	32,		511,
	0,		6,
	0,		0,
...
static struct pll_spec frd4311rpll_spec = {
	1,		63,
	32,		511,
	0,		6,
	0,		0,
...
static struct pll_spec gfrd5008ipll_spec = {
	1,              63,
	32,             511,
	0,              6,
	0,              0,
...
static struct pll_spec frd5602ipll_spec = {
	1,              63,
	64,             1023,
	0,              6,
	0,              0,
...
static struct pll_spec frd5312rpll_spec = {
	1,              63,
	64,             1023,
	0,              6,
	0,              0,
...
static struct pll_spec gfrd309ipll_spec = {
	1,		63,
	64,		1023,
	0,		6,
	0,		0,
...
static struct pll_spec gfrd309rpll_spec = {
	1,		63,
	32,		511,
	0,		6,
	0,		0,
...
struct pll_spec *pll_get_spec(struct cmucal_pll *pll)
{
	...
	case pll_0530x:
		...
		break;
	case frd_4311_rpll:
		pll_spec = &frd4311rpll_spec;
		break;
	case frd_4601_ipll:
		pll_spec = &frd4601ipll_spec;
		break;
	case frd_4312_rpll:
	...
	case pll_0532x:
		...
		break;
	case frd_5312_rpll:
		pll_spec = &frd5312rpll_spec;
		break;
	case frd_5602_ipll:
		pll_spec = &frd5602ipll_spec;
		break;
	case frd_309_rpll:
		pll_spec = &gfrd309rpll_spec;
		break;
	case frd_309_ipll:
		pll_spec = &gfrd309ipll_spec;
		break;
	default:
		pll_spec = NULL;
	}
