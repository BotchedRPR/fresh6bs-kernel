...
struct pmucal_seq chub_reset_release[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE,	"CHUB_CPU_CONFIGURATION", 	0x11860000, 0x3080, (0x1 << 0), (0x1 << 0),0,0,0,0),
	PMUCAL_SEQ_DESC(PMUCAL_WAIT,	"CHUB_CPU_STATUS",		0x11860000, 0x3084, (0x1 << 0), (0x1 << 0),0,0,0,0),
	//PMUCAL_SEQ_DESC(PMUCAL_WRITE,	"CHUB_CPU_OPTION",		0x11860000, 0x310c, (0x1 << 2), (0x0 << 2),0,0,0,0),
};
