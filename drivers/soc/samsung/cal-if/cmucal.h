...
#if defined(CONFIG_SOC_S5E9925) || defined(CONFIG_SOC_S5E9935) || defined(CONFIG_SOC_S5E8535 ) || defined(CONFIG_SOC_S5E8835)
...
extern bool (*is_ignore_cmu_dbg_type)(u32 type);
#else
static inline bool is_ignore_cmu_dbg_type(u32 type)
{
	return 0;
}
#endif
