...
#include <linux/samsung/pmic/s2mpu15-regulator-8535.h>
#include <linux/io.h>
...
static struct regulator_desc regulators[S2MPU15_REG_MAX] = {
	...
	//LDO_DESC("LDO20", _LDO(20), &_ldo_ops(), 1, _REG(_LDO20M_OUT2), 1, _REG(_LDO20M_CTRL), _TIME(_LDO)),
	...
	BUCK_DESC("BUCK1", _BUCK(1), &_buck_ops(), 1, _REG(_BUCK1M_OUT2), _REG(_BUCK1M_CTRL), _TIME(_BUCK)),
...
enum pmic_base_addr {
	...
	I2C_BASE_PM2 = 0x06,
	I2C_BASE_ADC = 0x0A,
	I2C_BASE_CLOSE1 = 0x0E,
	I2C_BASE_CLOSE2 = 0x0F,
};
