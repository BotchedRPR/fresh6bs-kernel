...
static const struct s2mpa05_oi_data s2mpa05_oi[] = {
	/* BUCK 1 to 4, OI function enable */
	DECLARE_OI(S2MPA05_PM1_BUCK1_OCP, 0x04),
	DECLARE_OI(S2MPA05_PM1_BUCK2_OCP, 0x04),
	DECLARE_OI(S2MPA05_PM1_BUCK3_OCP, 0x04),
	DECLARE_OI(S2MPA05_PM1_BUCK4_OCP, 0x04),
};
