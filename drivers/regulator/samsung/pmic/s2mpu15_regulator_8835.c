...
static const struct s2mpu15_oi_data s2mpu15_oi[] = {
	/* BUCK 1 to SR4M, OI function enable */
	DECLARE_OI(S2MPU15_PM1_BUCK1M_OCP, 0x04),
	DECLARE_OI(S2MPU15_PM1_BUCK2M_OCP, 0x04),
	DECLARE_OI(S2MPU15_PM1_BUCK3M_OCP, 0x04),
	DECLARE_OI(S2MPU15_PM1_BUCK4M_OCP, 0x04),
	DECLARE_OI(S2MPU15_PM1_BUCK5M_OCP, 0x04),
	DECLARE_OI(S2MPU15_PM1_BUCK6M_OCP, 0x04),
	DECLARE_OI(S2MPU15_PM1_BUCK7M_OCP, 0x04),
	DECLARE_OI(S2MPU15_PM1_BUCK8M_OCP, 0x04),
	DECLARE_OI(S2MPU15_PM1_BUCK_SR1M_OCP, 0x04),
	DECLARE_OI(S2MPU15_PM1_BUCK_SR2M_OCP, 0x04),
	DECLARE_OI(S2MPU15_PM1_BUCK_SR3M_OCP, 0x04),
	DECLARE_OI(S2MPU15_PM1_BUCK_SR4M_OCP, 0x04),
};
