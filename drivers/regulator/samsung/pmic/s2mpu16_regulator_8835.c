...
static struct regulator_desc regulators[S2MPU16_REG_MAX] = {
	...
	BUCK_DESC("BUCK_SR1", _BUCK(_SR1), &_buck_ops(), 2, _REG(_SR1S_OUT1), _REG(_SR1S_CTRL), _TIME(_BUCK)),
...
static const struct s2mpu16_oi_data s2mpu16_oi[] = {
	/* BUCK 1 to 10, SR1(BB) ,SR2 ,OI function enable */
	DECLARE_OI(S2MPU16_PM1_BUCK1S_OCP, 0x04),
	DECLARE_OI(S2MPU16_PM1_BUCK2S_OCP, 0x04),
	DECLARE_OI(S2MPU16_PM1_BUCK3S_OCP, 0x04),
	DECLARE_OI(S2MPU16_PM1_BUCK4S_OCP, 0x04),
	DECLARE_OI(S2MPU16_PM1_BUCK5S_OCP, 0x04),
	DECLARE_OI(S2MPU16_PM1_BUCK6S_OCP, 0x04),
	DECLARE_OI(S2MPU16_PM1_BUCK7S_OCP, 0x04),
	DECLARE_OI(S2MPU16_PM1_BUCK8S_OCP, 0x04),
	DECLARE_OI(S2MPU16_PM1_BUCK9S_OCP, 0x04),
	DECLARE_OI(S2MPU16_PM1_BUCK10S_OCP, 0x04),
	DECLARE_OI(S2MPU16_PM1_SR1S_OCP, 0x04),
	DECLARE_OI(S2MPU16_PM1_SR2S_OCP, 0x04),
};
