...
static const struct s2mpa05_oi_data s2mpa05_oi[] = {
	/* BUCK 1~4, OI function enable */
	DECLARE_OI(S2MPA05_REG_PM_BUCK1_OCP, 0x04),
	DECLARE_OI(S2MPA05_REG_PM_BUCK2_OCP, 0x04),
	DECLARE_OI(S2MPA05_REG_PM_BUCK3_OCP, 0x04),
	DECLARE_OI(S2MPA05_REG_PM_BUCK4_OCP, 0x04),
};
...
static struct pmic_device_attribute regulator_attr[] = {
	PMIC_ATTR(s2mpa05_write, S_IRUGO | S_IWUSR, s2mpa05_write_show, s2mpa05_write_store),
	PMIC_ATTR(s2mpa05_read, S_IRUGO | S_IWUSR, s2mpa05_read_show, s2mpa05_read_store),
};
