...
void __iomem *cp_shmem_get_region_with_size(u32 cp, u32 idx, u32 size);
...
void cp_shmem_set_size(u32 cp, u32 idx, u32 size);
...
static inline void __iomem *cp_shmem_get_region_with_size(u32 cp, u32 idx, u32 size) { return NULL; }
...
static inline void cp_shmem_set_size(u32 cp, u32 idx, u32 size) { return; }
