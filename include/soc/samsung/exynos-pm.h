...
extern inline void exynos_flexpmu_dbg_suspend_apm_req(void) { return; };
extern inline void exynos_flexpmu_dbg_resume_apm_req(void) { return; };
extern inline void acpm_print_mif_request(void) { return; }
#endif
