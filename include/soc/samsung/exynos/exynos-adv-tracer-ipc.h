...
static inline int adv_tracer_ipc_send_data_polling(unsigned int id,
			struct adv_tracer_ipc_cmd *cmd) { return 0; }
static inline int adv_tracer_ipc_send_data_polling_timeout(unsigned int id,
			struct adv_tracer_ipc_cmd *cmd,
			unsigned long timeout_ns) { return 0; }
static inline int adv_tracer_ipc_send_data_async(unsigned int id,
			struct adv_tracer_ipc_cmd *cmd) { return 0; }
