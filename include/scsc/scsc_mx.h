...
#define MIFRAMMAN_MEM_POOL_GENERIC		BIT(0)
/* Used for WLAN in split architecture */
#define MIFRAMMAN_MEM_POOL_WLAN  MIFRAMMAN_MEM_POOL_GENERIC
/* Used for buffers containing logs that will not be dumped by moredump */
#define MIFRAMMAN_MEM_POOL_LOGGING		BIT(1)
/* Used for WPAN in split architecture */
#define MIFRAMMAN_MEM_POOL_WPAN			BIT(2)
...
enum scsc_subsystem {
	SCSC_SUBSYSTEM_WLAN = 0,
	SCSC_SUBSYSTEM_WPAN = 1,
	SCSC_SUBSYSTEM_WLAN_WPAN = 2,
	SCSC_SUBSYSTEM_PMU = 3,
	SCSC_SUBSYSTEM_INVALID = 0xff,
};
