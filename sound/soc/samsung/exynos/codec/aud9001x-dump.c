		...
		loff_t *off)
{
	...
	if (g_command == COMMAND_DUMP) {
		...
		for (i = 0; i <= 255; i++) {
			...
			aud9001x_pmic_read_reg((u8)g_arg1, (u8)i, (u8 *)&value);
		...
		aud9001x_pmic_read_reg((u8)g_arg1, (u8)g_arg2, (u8 *)&value);
		...
		loff_t *off)
{
	...
	aud9001x_pmic_write_reg((u8)g_arg1, (u8)g_arg2, (u8)g_arg3);
	return len;
}
