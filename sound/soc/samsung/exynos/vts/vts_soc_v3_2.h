...
#ifndef __SND_SOC_VTS_DEP_SOC_V3_1_H
#define __SND_SOC_VTS_DEP_SOC_V3_1_H
...
#define VTS_CLK_DMIC_VAL		(24576000)
...
#define VTS_SRAMLOG_MSGS_OFFSET	   (0x00070000)
...
#define PAD_RETENTION_VTS_OPTION (0x20A0)  // VTS_OUT : PAD__RTO
#define VTS_CPU_CONFIGURATION	 (0x3280)
#define VTS_CPU_STATUS		(0x3284)
#define VTS_CPU_LOCAL_PWR_CFG	 (0x00000001)
#define VTS_CPU_IN      (0x32A4)
...
#define VTS_DMIC_CLK_MUX	(24576000)
#define SLIF_DMIC_CLK_MUX	(294912000)
#define DUAL_DMIC_CLK_MUX	(737280000)
...
#define VTS_SRAM_SZ 0x100000

#endif /* __SND_SOC_VTS_DEP_SOC_V3_1_H */
