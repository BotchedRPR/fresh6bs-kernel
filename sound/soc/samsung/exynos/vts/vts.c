...
static irqreturn_t vts_error_handler(int irq, void *dev_id)
{
	...
	case VTS_ERR_BUS_FAULT:
		...
		break;
	default:
		vts_dev_warn(dev, "undefined error_code: 0x%x\n", error_code);
...
#if defined(CONFIG_SOC_S5E9935) || defined(CONFIG_SOC_S5E8835) || defined(CONFIG_SOC_S5E5515)
...
static int vts_do_reg(struct device *dev, bool enable, int cmd) {
	...
	if (IS_ENABLED(CONFIG_SOC_S5E8825) || IS_ENABLED(CONFIG_SOC_S5E9935)
			|| IS_ENABLED(CONFIG_SOC_S5E8835) || IS_ENABLED(CONFIG_SOC_S5E5515)) {
		if (enable)
...
#if defined(CONFIG_SOC_S5E8835) || defined(CONFIG_SOC_S5E5515)
