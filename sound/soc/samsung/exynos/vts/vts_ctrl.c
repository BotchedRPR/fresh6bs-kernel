...
static int get_print_sfr(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	/* Nothing To Do */
...
static int set_print_sfr(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component = snd_soc_kcontrol_component(kcontrol);
	struct device *dev = component->dev;
	struct vts_data *data = vts_get_vts_data();
	...
	if (!vts_is_on()) {
		vts_dev_info(dev, "%s: vts is off\n", __func__);
		return 0;
	}

	vts_dev_info(dev, "%s: sfr: dmic_if0\n", __func__);
	vts_dev_info(dev, "%s: offset:0x0 value: 0x%x\n", __func__, readl(data->dmic_if0_base));
	vts_dev_info(dev, "%s: offset:0x4 value: 0x%x\n", __func__, readl(data->dmic_if0_base + 0x4));

	vts_dev_info(dev, "%s: sfr: sysreg_vts\n", __func__);
	vts_dev_info(dev, "%s: offset:0x104 value: 0x%x\n", __func__, readl(data->sfr_base));
	vts_dev_info(dev, "%s: offset:0x108 value: 0x%x\n", __func__, readl(data->sfr_base + 0x104));
	vts_dev_info(dev, "%s: offset:0x200 value: 0x%x\n", __func__, readl(data->sfr_base + 0x108));
	vts_dev_info(dev, "%s: offset:0x204 value: 0x%x\n", __func__, readl(data->sfr_base + 0x200));
	vts_dev_info(dev, "%s: offset:0x408 value: 0x%x\n", __func__, readl(data->sfr_base + 0x408));
	vts_dev_info(dev, "%s: offset:0x434 value: 0x%x\n", __func__, readl(data->sfr_base + 0x434));

	vts_dev_info(dev, "%s: sfr: dmic_ahb\n", __func__);
	vts_dev_info(dev, "%s: offset:0x0 value: 0x%x\n", __func__, readl(data->dmic_ahb0_base));
	vts_dev_info(dev, "%s: offset:0x4 value: 0x%x\n", __func__, readl(data->dmic_ahb0_base + 0x4));
	vts_dev_info(dev, "%s: offset:0x8 value: 0x%x\n", __func__, readl(data->dmic_ahb0_base + 0x8));
	vts_dev_info(dev, "%s: offset:0x10 value: 0x%x\n", __func__, readl(data->dmic_ahb0_base + 0x10));
	vts_dev_info(dev, "%s: offset:0x14 value: 0x%x\n", __func__, readl(data->dmic_ahb0_base + 0x14));
	vts_dev_info(dev, "%s: offset:0x18 value: 0x%x\n", __func__, readl(data->dmic_ahb0_base + 0x18));
	vts_dev_info(dev, "%s: offset:0x20 value: 0x%x\n", __func__, readl(data->dmic_ahb0_base + 0x20));
	vts_dev_info(dev, "%s: offset:0x24 value: 0x%x\n", __func__, readl(data->dmic_ahb0_base + 0x24));
	vts_dev_info(dev, "%s: offset:0x30 value: 0x%x\n", __func__, readl(data->dmic_ahb0_base + 0x30));
	vts_dev_info(dev, "%s: offset:0x34 value: 0x%x\n", __func__, readl(data->dmic_ahb0_base + 0x34));
	vts_dev_info(dev, "%s: offset:0x38 value: 0x%x\n", __func__, readl(data->dmic_ahb0_base + 0x38));
	vts_dev_info(dev, "%s: offset:0x40 value: 0x%x\n", __func__, readl(data->dmic_ahb0_base + 0x40));
	vts_dev_info(dev, "%s: offset:0x44 value: 0x%x\n", __func__, readl(data->dmic_ahb0_base + 0x44));
...
static const struct snd_kcontrol_new vts_ctrl_controls[] = {
	...
	SOC_SINGLE_EXT("Print SFR",
		SND_SOC_NOPM,
		0, 100, 0,
		get_print_sfr, set_print_sfr),
};
