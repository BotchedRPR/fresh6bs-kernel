...
#define IOVA_VSS_FIRMWARE_WIFI		(0xA0300000)
...
#define ABOX_LOG_OFFSET			(0x300000)
#define ABOX_LOG_MAJOR_OFFSET		(0xE0000)
#define ABOX_LOG_SIZE			(SZ_1M)
#define ABOX_LOG_MAJOR_SIZE		(0xA0000)
...
struct abox_data {
	...
	void *drv_args_addr_slog;
	size_t drv_args_size_slog;
	const char *modify_slog_size;
	int clk_diff_ppb;
	...
	enum companion_mode companion_mode;
	...
	int abox_dump_dai_cnt;
	struct mutex card_lock;
